...
game_menus = [
  ("start_game_0",menu_text_color(0xFF000000)|mnf_disable_all_keys,"Calradia Aftermath is a thrilling mod for Mount & Blade: Warband that picks up the story 250 years after the events of the original game. The once-prosperous land of Calradia now bears the scars of a cataclysmic event caused by the intrusion of dark magic into its realm. The aftermath of this calamity has reshaped the world, leaving it in a state of turmoil and uncertainty. As dark magic seeped into the land, ancient forces were unleashed, causing chaos and upheaval. Entire cities were engulfed in darkness, once-mighty kingdoms crumbled, and new factions rose to claim their share of the shattered realm. The delicate balance of power has shifted, and each faction vies for dominance in the turbulent landscape.",
    "none",
    [],
    [
     ("continue",[],"Continue...",
...
##  ),
  ...
  (
    ...
    "Welcome to Calradia Aftermath. Before you begin your journey, we need to know more about your character. Answer these questions to shape your destiny in this changed world.\
      Who was your father?",
    "none",
    [
    (str_clear,s10),
    ...
    [
      ("start_father_farmer",[],"A humble farmer who taught you the value of hard work and perseverance.",[
        (assign,"$background_type",cb_farmer),
        (assign, reg3, "$character_gender"),
        (str_store_string,s10,"@"),
        (jump_to_menu,"mnu_start_character_2"),
      ]),
      ("start_father_knight",[],"A renowned knight who instilled in you the principles of honor and chivalry.",[
        (assign,"$background_type",cb_knight),
        (assign, reg3, "$character_gender"),
        (str_store_string,s10,"@"),
        (jump_to_menu,"mnu_start_character_2"),
      ]),
      ("start_father_merchant",[],"A skilled merchant who showed you the secrets of trade and negotiation.",[
        (assign,"$background_type",cb_merchant),
        (assign, reg3, "$character_gender"),
        (str_store_string,s10,"@"),
        (jump_to_menu,"mnu_start_character_2"),
      ]),
      ("start_father_theif",[],"An elusive thief who taught you the art of stealth and thievery.",[
        (assign,"$background_type",cb_theif),
        (assign, reg3, "$character_gender"),
        (str_store_string,s11,"@{reg3?daughter:son}"),
        (str_store_string,s10,"@"),
        (jump_to_menu,"mnu_start_character_2"),
      ]),
      ("start_father_scolar",[],"A wise scholar who nurtured your love for learning and knowledge.",[
        (assign,"$background_type",cb_scolar),
        (assign, reg3, "$character_gender"),
        (str_store_string,s11,"@{reg3?daughter:son}"),
        (str_store_string,s10,"@"),
        (jump_to_menu,"mnu_start_character_2"),
      ]),
      ("start_father_warlord",[],"A powerful warlord who led you to embrace a life of warfare.",[
        (assign,"$background_type",cb_warlord),
        (assign, reg3, "$character_gender"),
        (str_store_string,s10,"@"),
        (jump_to_menu,"mnu_start_character_2"),
      ]),
  ...
  (
    ...
    [
      (
        "childhood_orphan",[],"You grew up as an orphan on the streets, learning to survive through cunning and street smarts.",
        [
          (assign,"$background_answer_2", cb2_orphan),
          (assign, reg3, "$character_gender"),
      ...
      (
        "childhood_village",[],"You were raised in a peaceful village, surrounded by nature and the warmth of the community.",
        [
          (assign,"$background_answer_2", cb2_village),
          (assign, reg3, "$character_gender"),
          (str_store_string,s11,"@"),
          (jump_to_menu,"mnu_start_character_3"),
        ]
      ...
      ("childhood_martial",[
          ],"You were trained in a martial academy, honing your combat skills and discipline.",[
          (assign,"$background_answer_2",cb2_martial),
          (assign, reg3, "$character_gender"),
          (str_store_string,s11,"@"),
      (jump_to_menu,"mnu_start_character_3"),
    ]),
      ("childhood_exploration",[
          ],"You spent your childhood exploring ancient ruins, uncovering relics and lost artifacts.",[
      (assign,"$background_answer_2",cb2_explorer),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@"),
	(jump_to_menu,"mnu_start_character_3"),
    ]),
      (
        "childhood_noble",[],"You lived in a noble castle, receiving proper education and etiquette as a future noble.",
        [
          (assign,"$background_answer_2",cb2_noble),
          (assign, reg3, "$character_gender"),
          (str_store_string,s11,"@"),
          (jump_to_menu,"mnu_start_character_3"),
        ]
      ...
      (
        "childhood_nomad",[],"You were part of a nomadic tribe, roaming the vast lands and learning the ways of the wilderness.",
        [
          (assign,"$background_answer_2",cb2_nomad),
          (assign, reg3, "$character_gender"),
          (str_store_string,s11,"@"),
          (jump_to_menu,"mnu_start_character_3"),
        ]
  ...
  (
    ...
    "Who did you become when grown up?",
    "none",
    [(assign, reg3, "$character_gender"),],
    [
      ("adult_knight",[(eq,"$character_gender",tf_male)],"A brave and noble knight, devoted to protecting the innocent and upholding justice.",[
        (assign,"$background_answer_3",cb3_knight),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s12,"@"),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("adult_heroine",[(eq,"$character_gender",tf_female)],"A brave heroine, devoted to protecting the innocent and upholding justice.",[
        (assign,"$background_answer_3",cb3_heroine),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@"),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("adult_mercenary",[],"A ruthless and cunning mercenary, mastering the art of combat for profit.",[
        (assign,"$background_answer_3",cb3_mrcenary),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@"),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("adult_trader",[],"A shrewd and successful trader, amassing wealth and wielding economic power.",[
        (assign,"$background_answer_3",cb3_trader),
      (str_store_string,s12,"@"),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("adult_archer",[],"A skilled archer, known for your accuracy and prowess with the bow.",[
        (assign,"$background_answer_3",cb3_archer),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@"),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("adult_leader",[],"A charismatic and influential leader, gathering followers to build your own faction.",[
        (assign,"$background_answer_3", cb3_leader),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@"),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("adult_raider",[],"A relentless raider, embracing a life of plunder and conquest.",[
        (assign,"$background_answer_3", cb3_raider),
      (str_store_string,s14,"@{reg3?daughter:man}"),
      (str_store_string,s13,"@{reg3?woman:man}"),
      (str_store_string,s12,"@"),
	(jump_to_menu,"mnu_start_character_4"),
  ...
  (
    ...
    [],
    [
      ("motivation_revenge",[],"Seeking vengeance for a past injustice or personal tragedy.",[
        (assign,"$background_answer_4", cb4_revenge),
      (str_store_string,s13,"@"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("motivation_adventure",[],"A thirst for adventure and the desire to explore the unknown.",[
        (assign,"$background_answer_4", cb4_adventure),
      (str_store_string,s13,"@"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("motivation_wealth",[],"Acquiring wealth and becoming the most prosperous in the land.",[
        (assign,"$background_answer_4", cb4_wealth),
      (str_store_string,s13,"@"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("motivation_fame",[],"Gaining fame and recognition for your skills and deeds.",[
        (assign,"$background_answer_4",cb4_fame),
      (str_store_string,s13,"@"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
     ("motivation_legacy",[],"Establishing a legacy and leaving a mark on history.",[
        (assign,"$background_answer_4",cb4_legacy),
      (str_store_string,s13,"@"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("motivation_chaos",[],"Bringing chaos and disorder to a world that wronged you.",[
        (assign,"$background_answer_4",cb4_chaos),
      (str_store_string,s13,"@"),
        (jump_to_menu,"mnu_choose_skill"),
        ]),
      ("go_back",[],"Go back.",
      ...
      (
        ...
        [
          ...
          (try_begin),
            ...
            (troop_add_item, "trp_player","itm_pitch_fork",imod_battered),
          ...
          (else_try),
            ...
            (troop_add_item, "trp_player","itm_scythe",imod_battered),
          ...
          (else_try),
            ...
            (troop_add_item, "trp_player","itm_shield_heater_c",imod_battered),
            (troop_add_gold, "trp_player", 50),
            (troop_set_slot, "trp_player", slot_troop_renown, 10),
          (else_try),
            (eq,"$background_type",cb_theif),
            (troop_raise_attribute, "trp_player",ca_strength,1),
            ...
            (troop_add_item, "trp_player","itm_throwing_daggers",imod_large_bag),
            (troop_add_gold, "trp_player", 30),
          (else_try),
            (eq,"$background_type",cb_scolar),
            (eq,"$character_gender",tf_male),
            (troop_raise_attribute, "trp_player",ca_intelligence,4),
            (troop_raise_attribute, "trp_player",ca_charisma,2),
            (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,15),
            (troop_add_item, "trp_player","itm_book_engineering",imod_battered),
          ...
          (else_try),
            ...
            (troop_raise_attribute, "trp_player",ca_charisma,1),
            (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,15),
            (troop_add_item, "trp_player","itm_book_wound_treatment_reference",imod_battered),
            (troop_add_gold, "trp_player", 15),
            (troop_set_slot, "trp_player", slot_troop_renown, 10),
          (else_try),
            (eq,"$background_type",cb_warlord),
            (troop_raise_attribute, "trp_player",ca_agility,3),
          ...
          (try_begin),
            (eq,"$background_answer_2",cb2_orphan),
            (troop_raise_attribute, "trp_player",ca_strength,2),
            (troop_raise_skill, "trp_player","skl_power_strike",2),
            (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,5),
            (troop_raise_proficiency, "trp_player",wpt_polearm,5),
          (else_try),
            (eq,"$background_answer_2",cb2_village),
            (troop_raise_attribute, "trp_player",ca_agility,1),
            (troop_raise_attribute, "trp_player",ca_strength,1),
            (troop_raise_skill, "trp_player","skl_engineer",1),
            (troop_raise_skill, "trp_player","skl_trade",1),
          (else_try),
            (eq,"$background_answer_2",cb2_martial),
            (troop_raise_attribute, "trp_player",ca_agility,2),
            (troop_raise_attribute, "trp_player",ca_strength,2),
            (troop_raise_skill, "trp_player","skl_power_strike",2),
            (troop_raise_skill, "trp_player","skl_ironflesh",2),
          (else_try),
            (eq,"$background_answer_2",cb2_explorer),
            (troop_raise_attribute, "trp_player",ca_agility,2),
            (troop_raise_attribute, "trp_player",ca_intelligence,1),
          ...
          (else_try),
            (eq,"$background_answer_2",cb2_noble),
            (troop_raise_attribute, "trp_player",ca_intelligence,1),
            (troop_raise_attribute, "trp_player",ca_charisma,1),
            (troop_raise_attribute, "trp_player",ca_strength,1),
            (troop_raise_attribute, "trp_player",ca_agility,1),
            ...
            (troop_raise_skill, "trp_player","skl_trade",1),
          (else_try),
            (eq,"$background_answer_2",cb2_nomad),
            (troop_raise_attribute, "trp_player",ca_strength,1),
            (troop_raise_attribute, "trp_player",ca_agility,3),
          ...
          (try_begin),
            (eq,"$background_answer_3",cb3_knight),
            (troop_raise_attribute, "trp_player",ca_strength,1),
            (troop_raise_attribute, "trp_player",ca_agility,1),
            (troop_raise_skill, "trp_player","skl_power_strike",1),
            (troop_raise_skill, "trp_player","skl_riding",1),
            ...
            (troop_add_item, "trp_player","itm_spear",0),
            (troop_add_item, "trp_player","itm_m_corrazina_a",imod_rusty),
            (troop_add_item, "trp_player","itm_m_hose_a",0),
            (troop_add_item, "trp_player","itm_sumpter_horse",imod_heavy),
            (troop_add_item, "trp_player","itm_dried_meat",0),
            (troop_add_item, "trp_player","itm_tab_shield_heater_a",0),
            (troop_add_item, "trp_player","itm_m_sallet_light_a",imod_rusty),
          (else_try),
            (eq,"$background_answer_3",cb3_heroine),
            (eq,"$character_gender",tf_female),
            (troop_raise_attribute, "trp_player",ca_agility,2),
            (troop_raise_attribute, "trp_player",ca_intelligence,1),
        ...
        (troop_raise_skill, "trp_player","skl_engineer",1),
            ...
            (troop_add_item, "trp_player","itm_m_hose_c",imod_ragged),
            (troop_add_item, "trp_player","itm_red_gambeson",0),
            (troop_add_item, "trp_player","itm_italian_falchion",0),
            (troop_add_item, "trp_player","itm_m_chapel_light_b",0),
            (troop_add_item, "trp_player","itm_saddle_horse",0),
            (troop_add_item, "trp_player","itm_smoked_fish",0),
          (else_try),
            (eq,"$background_answer_3",cb3_mrcenary),
            (troop_raise_attribute, "trp_player",ca_charisma,1),
            (troop_raise_attribute, "trp_player",ca_agility,2),
            (troop_raise_attribute, "trp_player",ca_strength,1),
            (troop_raise_skill, "trp_player","skl_riding",1),
        ...
        (troop_add_item, "trp_player","itm_leather_gloves",imod_plain),
            ...
            (troop_add_item, "trp_player","itm_m_hauberk_b",0),
            (troop_add_item, "trp_player","itm_m_hose_e",0),
            (troop_add_item, "trp_player","itm_m_bascinet_a",0),
            (troop_add_item, "trp_player","itm_long_hafted_knobbed_mace",0),
            (troop_add_item, "trp_player","itm_bollock_dagger",0),
            (troop_add_item, "trp_player","itm_bolts",0),
            (troop_add_item, "trp_player","itm_tab_shield_small_round_a",0),
            (troop_add_item, "trp_player","itm_m_gloves_a",0),
            (troop_add_item, "trp_player","itm_smoked_fish",0),
          (else_try),
            (eq,"$background_answer_3",cb3_trader),
            (troop_raise_attribute, "trp_player",ca_charisma,2),
            (troop_raise_attribute, "trp_player",ca_intelligence,1),
        ...
        (troop_raise_skill, "trp_player","skl_weapon_master",1),
            ...
            (troop_add_item, "trp_player","itm_red_shirt",0),
            (troop_add_item, "trp_player","itm_m_leather_boots_a",0),
            (troop_add_item, "trp_player","itm_milanese_sword", imod_rusty),
            (troop_add_item, "trp_player","itm_hunting_crossbow", 0),
            (troop_add_item, "trp_player","itm_bolts", 0),
            (troop_add_item, "trp_player","itm_saddle_horse",imod_swaybacked),
            (troop_add_item, "trp_player","itm_smoked_fish",0),
          (else_try),
            (eq,"$background_answer_3",cb3_archer),
            (troop_raise_attribute, "trp_player",ca_strength,1),
            ...
            (troop_add_item, "trp_player","itm_mt_hood_a3",0),
            (troop_add_item, "trp_player","itm_mt_leather_boots_e",0),
            (troop_add_item, "trp_player","itm_mt_leather_armor_b",0),
              
            (troop_add_item, "trp_player","itm_longbowman_sword", imod_rusty),
            (troop_add_item, "trp_player","itm_hunting_bow",0),
            (troop_add_item, "trp_player","itm_arrows",0),
            (troop_add_item, "trp_player","itm_smoked_fish",0),
          (else_try),
            (eq,"$background_answer_3",cb3_leader),
            (troop_raise_attribute, "trp_player",ca_intelligence,1),
            ...
            (troop_add_item, "trp_player","itm_m_leather_boots_a",0),
            (troop_add_item, "trp_player","itm_tab_shield_small_round_a",0),
            (troop_add_item, "trp_player","itm_scottish_sword", imod_rusty),
          ...
          (else_try),
            (eq,"$background_answer_3",cb3_raider),
            (troop_raise_attribute, "trp_player",ca_strength,2),
            (troop_raise_attribute, "trp_player",ca_agility,4),
            ...
            (troop_add_item, "trp_player","itm_ms_helmet_b",imod_sturdy),
            (troop_add_item, "trp_player","itm_ms_byrnie_a",imod_rusty),
            (troop_add_item, "trp_player","itm_m_gloves_a",0),
            (troop_add_item, "trp_player","itm_m_leather_boots_a",0),
            (troop_add_item, "trp_player","itm_one_handed_battle_axe_a", imod_rusty),
            (troop_add_item, "trp_player","itm_javelin", 0),
            (troop_add_item, "trp_player","itm_saddle_horse",0),
          ...
          (try_begin),
            ...
            (troop_raise_skill, "trp_player","skl_power_strike",1),
          (else_try),
            (eq,"$background_answer_4",cb4_legacy),
            (troop_raise_attribute, "trp_player",ca_charisma,2),
            (troop_raise_skill, "trp_player","skl_ironflesh",1),
          (else_try),
            (eq,"$background_answer_4",cb4_adventure),
            (troop_raise_attribute, "trp_player",ca_agility,2),
            (troop_raise_skill, "trp_player","skl_pathfinding",1),
          (else_try),
            (eq,"$background_answer_4",cb4_fame),
            (troop_raise_attribute, "trp_player",ca_strength,1),
            (troop_raise_attribute, "trp_player",ca_intelligence,1),
            (troop_raise_skill, "trp_player","skl_weapon_master",1),
          (else_try),
            (eq,"$background_answer_4",cb4_wealth),
            (troop_raise_attribute, "trp_player",ca_agility,1),
            (troop_raise_attribute, "trp_player",ca_intelligence,1),
            (troop_raise_skill, "trp_player","skl_looting",1),
          (else_try),
            (eq,"$background_answer_4",cb4_chaos),
            (troop_raise_attribute, "trp_player",ca_charisma,1),
            (troop_raise_attribute, "trp_player",ca_strength,4),
            (troop_raise_skill, "trp_player","skl_power_strike",2),
            (troop_raise_skill, "trp_player","skl_ironflesh",1),
