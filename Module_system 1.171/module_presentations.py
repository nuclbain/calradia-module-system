    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),
        ...
        (assign, ":cur_troop", "trp_nerpa_black_head"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_8"),
        (assign, ":cur_troop", "trp_hairako_mounted_shaitan"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_9"),
        (assign, ":cur_troop", "trp_tauria_noble_knight"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_10"),
        (assign, ":cur_troop", "trp_elen_white_hood"),
      (else_try),
