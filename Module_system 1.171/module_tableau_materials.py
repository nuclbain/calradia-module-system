...
###
  ("sarranid_shield_a", 0, "sample_tableau_shield_sarranid_a", 512, 512, 0, 0, 0, 0,
   [   (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 10),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_shield_sarranids_a", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),

  ("sarranid_shield_b", 0, "sample_tableau_shield_sarranid_b", 1024, 1024, 0, 0, 0, 0,
   [   (store_script_param, ":banner_mesh", 1),
       (set_fixed_point_multiplier, 100),
       (init_position, pos1),
       (position_set_x, pos1, -43),
       (position_set_y, pos1, 150),
       (cur_tableau_add_mesh, ":banner_mesh", pos1, 127, 0),#118
       (init_position, pos1),
       (position_set_z, pos1, 10),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_shield_sarranids_b", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),

  ("sarranid_shield_c", 0, "sample_tableau_shield_sarranid_c", 1024, 1024, 0, 0, 0, 0,
   [   (store_script_param, ":banner_mesh", 1),
       (set_fixed_point_multiplier, 100),
       (init_position, pos1),
       (position_set_x, pos1, -50),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 10),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_shield_sarranids_c", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
  ...
  ("player_shield_a", 0, "sample_tableau_shield_sarranid_a", 1024, 1024, 0, 0, 0, 0,
   [   (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 10),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_shield_player_a", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),

  ("player_shield_b", 0, "sample_tableau_shield_sarranid_a", 1024, 1024, 0, 0, 0, 0,
   [   (store_script_param, ":banner_mesh", 1),
       (set_fixed_point_multiplier, 100),
       (init_position, pos1),
       (position_set_x, pos1, -55),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 10),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_shield_player_b", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
###
...
##       (cur_tableau_add_override_item, "itm_m_greaves_a"),
##       (assign, ":animation", "anim_pose_5"),
##     (try_end),
##
##     (init_position, pos2),
