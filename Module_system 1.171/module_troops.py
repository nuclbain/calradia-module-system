...
#This troop is the troop marked as soldiers_begin
  ...
  ["watchman","Watchman","Watchmen",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield,no_scene,reserved,fac_commoners,
   [itm_bolts,itm_mace_3,itm_mace_3,itm_fighting_pick,itm_sword_medieval_a,itm_spear,itm_hunting_crossbow,itm_light_crossbow,itm_shield_kite_k,itm_aketon_green,itm_shirt_a_padded_new,itm_red_gambeson,itm_m_light_infantry_helmet_d,itm_m_light_infantry_helmet_e,itm_m_leather_boots_a,itm_m_swadia_milita_boots_a,itm_m_swadia_milita_boots_b,itm_m_swadia_leather_boots_a,itm_m_swadia_leather_boots_b,itm_leather_gloves,itm_m_gloves_a],
