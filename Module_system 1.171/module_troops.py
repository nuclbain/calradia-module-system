...
# silver rose units
["silver_rose_novice","Silver Rose Novice","Silver Rose Novice",tf_guarantee_boots|tf_guarantee_armor,0,0,fac_kingdom_1,[itm_scythe,itm_hatchet,itm_pitch_fork,itm_stones,itm_pickaxe,itm_tab_shield_heater_a,itm_tab_shield_round_a,itm_m_aketon_silver_rose_a,itm_m_aketon_silver_rose_b,itm_m_leather_silver_rose_b,itm_m_arming_cap_b,itm_m_hose_d,itm_old_leather_gloves], def_attrib|level(5),wp(60),knows_common,swadian_face_younger_1, swadian_face_middle_2],
...
#peasant - retainer - footman - man-at-arms -  knight
  ["silver_rose_levy","Silver Rose Levy","Silver Rose Levy",tf_guarantee_boots|tf_guarantee_armor,0,0,fac_kingdom_1,
   [itm_falshion_1, itm_crusader_sword_a,itm_crusader_sword_b,itm_crusader_sword_c,itm_swadia_oval_shield_1,itm_swadia_oval_shield_2,itm_silver_rose_aketon,itm_m_swadia_recruit_plated_a,itm_m_arming_cap_b,itm_leather_boots,itm_m_spiked_helmet_a,itm_iron_crown_nasal_a,itm_silver_rose_footman_helmet,itm_leather_gloves],
  ...
  ["silver_rose_knight","Silver Rose Knight","Silver Rose Knights",tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_gloves|tf_guarantee_helmet|tf_guarantee_horse|tf_guarantee_shield,0,0,fac_kingdom_1,
   [itm_crusader_knight_spear_a,itm_k_long_sword_a,itm_k_long_sword_b,itm_k_long_sword_c,itm_swadia_heater_shield_1,itm_swadia_heater_shield_2,itm_m_silver_rose_breastplate_heavy_a,itm_m_silver_rose_plate_a,itm_m_silver_rose_plate_b,itm_m_silver_rose_plate_c,itm_m_silver_rose_breastplate_heavy_b,itm_m_knigh_helm_a,itm_m_knigh_helm_b,itm_m_knigh_helm_c,itm_m_knigh_helm_d,itm_m_knigh_helm_e,itm_m_knigh_helm_f,itm_mail_chausses,itm_m_gauntlets_a,itm_silver_rose_heavy_horse_a],
