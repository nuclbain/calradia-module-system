...
def_attrib|level(25),wp_melee(135)|wp_throwing(100),knows_common|knows_shield_3|knows_ironflesh_3|knows_power_strike_3,swadian_face_middle_1, swadian_face_older_2],
  ...
  ["looter","Looter","Looters",tf_guarantee_armor|tf_guarantee_boots,0,0,fac_outlaws,
   [itm_stormguard_aketon_a, itm_stormguard_aketon_plated_a, itm_stormguard_aketon_b, itm_m_aketon_a, itm_neutral_aketon_a, itm_neutral_aketon_b, itm_stormguard_aketon_a, itm_stormguard_aketon_b, itm_m_plain_round_shield_a, itm_m_plain_round_shield_b, itm_m_plain_round_shield_c, itm_m_plain_round_shield_d, itm_m_plain_round_shield_e, itm_grosse_messer, itm_falchion, itm_italian_falchion, itm_boar_spear, itm_head_wrappings, itm_leather_cap, itm_black_hood, itm_black_hood, itm_m_arming_cap_c, itm_m_arming_cap_a, itm_m_coif_cloth_a, itm_m_coif_cloth_b, itm_m_swadia_common_helmet_b, itm_m_padded_coif_a, itm_m_padded_coif_b, itm_leather_gloves],
