...
factions = [
    ...
    (
        ...
        0,
        0.5,
        [("manhunters", -0.6), ("merchants", -0.5), ("player_faction", -0.1)],
        [],
        0x488538,
    ),
    (
