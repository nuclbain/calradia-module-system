...
items = [
    ...
    [
        ...
        "Spear",
        [("spear", 0)],
        itp_type_polearm | itp_primary | itp_penalty_with_shield | itp_wooden_parry,
        itc_spear,
        0,
        weight(4.5)
        | difficulty(0)
    ...
    [
        ...
        "Club",
        [("club_v3", 0)],
        itp_type_one_handed_wpn | itp_primary | itp_wooden_parry | itp_wooden_attack,
        itc_scimitar,
        0,
        weight(2.5)
        | difficulty(0)
    ...
    [
        ...
        itp_type_bow | itp_primary | itp_two_handed,
    ...
    [
        ...
        "Crossbow",
        [("crossbow", 0)],
        itp_type_crossbow | itp_primary | itp_two_handed | itp_cant_reload_on_horseback,
        ...
        | spd_rtng(42)
        | shoot_speed(68)
        | thrust_damage(32, pierce)
        | max_ammo(1),
        imodbits_crossbow,
    ],
    [
        "tutorial_throwing_daggers",
        "Throwing Daggers",
        [("throwing_dagger", 0)],
    ...
    [
        ...
        | itp_wooden_parry
        | itp_wooden_attack,
        itc_parry_polearm | itcf_carry_sword_back,
        9,
        weight(3.5)
        | spd_rtng(120)
        | weapon_length(115)
    ...
    [
        ...
        | itp_wooden_parry
        | itp_wooden_attack,
        itc_staff | itcf_carry_sword_back,
        9,
        weight(3.5)
        | spd_rtng(120)
        | weapon_length(115)
        | swing_damage(16, blunt)
        | thrust_damage(16, blunt),
        imodbits_none,
    ],
    [
        "tutorial_sword",
        "Sword",
        [("long_sword", 0), ("scab_longsw_a", ixmesh_carry)],
    ...
    [
        ...
        "Horse Meat",
        [("raw_meat", 0)],
        itp_type_goods | itp_consumable | itp_food,
        0,
        12,
    ...
    [
        ...
        | itp_no_parry
        | itp_wooden_attack,
        itc_dagger | itcf_carry_dagger_front_left,
        2,
        weight(0.5)
        | spd_rtng(110)
        | weapon_length(47)
        | swing_damage(16, blunt)
        | thrust_damage(14, blunt),
        imodbits_none,
    ],
    [
        "practice_axe",
    ...
    [
        ...
        itcf_shoot_bow | itcf_carry_bow_back,
        0,
        weight(1.5) | spd_rtng(90) | shoot_speed(40) | thrust_damage(21, blunt),
        imodbits_bow,
    ],
    ...
    [
        ...
        0,
        37,
        body_armor(10) | horse_speed(40) | horse_maneuver(37) | horse_charge(14),
        imodbits_none,
    ],
    [
        "practice_arrows",
        ...
        itcf_carry_quiver_back,
        0,
        weight(1.5) | weapon_length(95) | max_ammo(80),
        imodbits_missile,
    ],
    ...
    [
        ...
        [
            ...
            ("flying_missile", ixmesh_flying_ammo),
            ("crusade_bolt_bag", ixmesh_carry),
            ("crusade_bolt_bag", ixmesh_carry | imodbit_large_bag),
        ],
        itp_type_bolts,
        itcf_carry_quiver_right_vertical,
        0,
        weight(2.25) | weapon_length(55) | max_ammo(49),
        imodbits_missile,
    ],
    [
        ...
        itcf_carry_quiver_back,
        0,
        weight(1.5) | weapon_length(95) | max_ammo(10),
        imodbits_missile,
    ],
    [
        ...
        itcf_carry_quiver_back,
        0,
        weight(1.5) | weapon_length(95) | max_ammo(100),
        imodbits_missile,
    ],
    [
        ...
        itcf_carry_quiver_right_vertical,
        0,
        weight(2.25) | weapon_length(55) | max_ammo(9),
        imodbits_missile,
    ],
    [
        "practice_boots",
        "Practice Boots",
        [("boot_nomad_a", 0)],
        itp_type_foot_armor | itp_civilian | itp_attach_armature,
        0,
        11,
    ...
    [
        ...
        0,
        650,
        weight(16) | abundance(100) | head_armor(0) | body_armor(29) | leg_armor(13),
        imodbits_armor,
    ],
    [
        "arena_armor_red",
    ...
    [
        ...
        0,
        187,
        weight(1.25) | abundance(100) | head_armor(20) | body_armor(0) | leg_armor(0),
        imodbits_plate,
    ],
    [
        "steppe_helmet_red",
    ...
    [
        ...
        "Tourney Helm White",
        [("tourney_helmR", 0)],
        itp_type_head_armor | itp_covers_head,
        0,
        760,
        weight(2.75) | abundance(100) | head_armor(30) | body_armor(0) | leg_armor(0),
        imodbits_plate,
    ],
    [
        "tourney_helm_red",
    ...
    [
        "book_leadership",
        "The Life of Alixenus the Great",
        [("book_d", 0)],
        itp_type_book,
        0,
        4200,
    ...
    [
        ...
        0,
        1025,
        weight(40) | abundance(30),
        imodbits_none,
    ],
    [
        "cheap_smithing_material",
        "Common Materials",
        [("Common_Materials", 0), ("Common_Materials.1", 0), ("Common_Materials.2", 0)],
        itp_merchandise | itp_type_goods,
        0,
        120,
        weight(60) | abundance(60),
        imodbits_none,
    ],
    [
        "regular_smithing_material",
        "Uncommon Materials",
        [
            ("Uncommon_Materials", 0),
            ("Uncommon_Materials.1", 0),
            ("Uncommon_Materials.2", 0),
        ],
        itp_merchandise | itp_type_goods,
        0,
        400,
    ...
    [
        "expensive_smithing_material",
        "Rare Materials",
        [("Rare_Materials", 0), ("Rare_Materials.1", 0), ("Rare_Materials.2", 0)],
        itp_merchandise | itp_type_goods,
        0,
        1200,
        weight(60) | abundance(60),
    ...
    [
        ...
        [
            ("Weaponsmith_Tools", 0),
            ("Weaponsmith_Tools.1", 0),
            ("Weaponsmith_Tools.2", 0),
        ],
        itp_merchandise | itp_type_goods,
        0,
        2500,
    ...
    [
        "armorer_tools",
        "Armorer Toolkit",
        [("Armorer_Tools", 0), ("Armorer_Tools.1", 0), ("Armorer_Tools.2", 0)],
        itp_merchandise | itp_type_goods,
        0,
        2500,
        weight(50) | abundance(90),
    ...
    [
        ...
        0,
        120,
        weight(40) | food_quality(10) | max_ammo(10),
        imodbits_none,
    ],
    [
        "furs",
    ...
    [
        ...
        0,
        65,
        weight(15) | abundance(110) | food_quality(50) | max_ammo(50),
        imodbits_none,
    ],
    [
        "cheese",
    ...
    [
        ...
        0,
        220,
        weight(5) | abundance(110) | food_quality(40) | max_ammo(30),
        imodbits_none,
    ],
    [
        "sausages",
        ...
        0,
        85,
        weight(10) | abundance(110) | food_quality(40) | max_ammo(40),
        imodbits_none,
    ],
    [
        "cabbages",
        ...
        0,
        30,
        weight(15) | abundance(110) | food_quality(40) | max_ammo(50),
        imodbits_none,
    ],
    [
        "dried_meat",
        ...
        0,
        85,
        weight(15) | abundance(100) | food_quality(70) | max_ammo(50),
        imodbits_none,
    ],
    [
        "apples",
        ...
        0,
        44,
        weight(20) | abundance(110) | food_quality(40) | max_ammo(50),
        imodbits_none,
    ],
    [
        "raw_grapes",
        "Grapes",
        [("grapes_inventory", 0)],
        itp_merchandise | itp_consumable | itp_type_goods,
        0,
        75,
        weight(40) | abundance(90) | food_quality(10) | max_ammo(10),
        imodbits_none,
    ],  # x2 for wine
    [
        "raw_olives",
    ...
    [
        ...
        0,
        30,
        weight(30) | abundance(110) | food_quality(40) | max_ammo(50),
        imodbits_none,
    ],
    [
        "cattle_meat",
        ...
        0,
        80,
        weight(20) | abundance(100) | food_quality(80) | max_ammo(50),
        imodbits_none,
    ],
    [
        "bread",
    ...
    [
        ...
        0,
        95,
        weight(10) | abundance(110) | food_quality(40) | max_ammo(50),
        imodbits_none,
    ],
    [
        "pork",
    ...
    [
        ...
        0,
        46,
        weight(40) | abundance(60) | max_ammo(50),
        imodbits_none,
    ],
    [
        "quest_ale",
    ...
    [
        "saddle_horse",
        "Saddle Horse",
        [("horse_bandits_b", 0), ("horse_bandits_b.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        240,
        abundance(90)
    ...
    [
        "saddle_horse_b",
        "Saddle Horse",
        [("horse_bandits_d", 0), ("horse_bandits_d.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        240,
        abundance(90)
    ...
    [
        "steppe_horse",
        "Steppe Horse",
        [("bandits_horse_a", 0), ("bandits_horse_a.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        192,
        abundance(80)
    ...
    [
        "steppe_horse_b",
        "Steppe Horse",
        [("bandits_horse_b", 0), ("bandits_horse_b.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        192,
        abundance(80)
    ...
    [
        "steppe_horse_c",
        "Steppe Horse",
        [("bandits_horse_c", 0), ("bandits_horse_c.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        192,
        abundance(80)
    ...
    [
        "steppe_horse_d",
        "Steppe Horse",
        [("bandits_horse_d", 0), ("bandits_horse_d.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        201,
        abundance(80)
    ...
    [
        "arabian_horse_a",
        "Desert Horse",
        [("Arabs_horse_a", 0), ("Arabs_horse_a.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        550,
        abundance(80)
    ...
    [
        "arabian_horse_b",
        "Desert Horse",
        [("Arabs_horse_b", 0), ("Arabs_horse_b.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        550,
        abundance(80)
    ...
    [
        "arabian_horse_c",
        "Desert Horse",
        [("Arabs_horse_c", 0), ("Arabs_horse_c.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        550,
        abundance(80)
    ...
    [
        "arabian_horse_d",
        "Desert Horse",
        [("Arabs_horse_d", 0), ("Arabs_horse_d.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        550,
        abundance(80)
    ...
    [
        "courser",
        "Courser",
        [("horse_bandits_c", 0), ("horse_bandits_c.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        600,
        abundance(70)
    ...
    [
        "hunter",
        "Hunter",
        [("European_horse_a", 0), ("European_horse_a.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        810,
        abundance(60)
    ...
    [
        "hunter_b",
        "Hunter",
        [("European_horse_b", 0), ("European_horse_b.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        810,
        abundance(60)
    ...
    [
        "hunter_c",
        "Hunter",
        [("European_horse_c", 0), ("European_horse_c.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        810,
        abundance(60)
    ...
    [
        "hunter_d",
        "Hunter",
        [("European_horse_d", 0), ("European_horse_d.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        810,
        abundance(60)
    ...
    [
        "hunter_e",
        "Hunter",
        [("European_horse_e", 0), ("European_horse_e.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        810,
        abundance(60)
    ...
    [
        "hunter_f",
        "Hunter",
        [("European_horse_f", 0), ("European_horse_f.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        810,
        abundance(60)
    ...
    [
        ...
        imodbits_horse_basic | imodbit_champion,
        [],
        [fac_kingdom_12, fac_kingdom_5, fac_kingdom_9],
    ],
    [
        "elen_warhorse_a",
        "Elen War Horse",
        [("Warhorse_Elen_B", 0), ("Warhorse_Elen_B.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        1109,
        abundance(50)
    ...
    [
        "elen_warhorse_b",
        "Elen War Horse",
        [("Warhorse_Elen_A", 0), ("Warhorse_Elen_A.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        1227,
        abundance(50)
    ...
    [
        "charger",
        "Charger",
        [("Charger_A", 0), ("Charger_A.1", 0), ("Charger_A.2", 0)],
        itp_merchandise | itp_type_horse,
        0,
        1811,
        abundance(40)
    ...
    [
        ...
        "Silver Rose Knight Horse",
        [("Silver_Rose_Knight_Horse_A", 0), ("Silver_Rose_Knight_Horse_A.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        1499,
        abundance(50)
    ...
    [
        "black_knight_horse_a",
        "Knight Horse",
        [("Black_Knight_Horse_A", 0), ("Black_Knight_Horse_A.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        1499,
        abundance(20)
    ...
    [
        ...
        "Heaby Bolts",
        [
            ("crusade_bolt_heavy", 0),
            ("flying_missile", ixmesh_flying_ammo),
            ("crusade_bolt_bag_heavy", ixmesh_carry),
        ],
    ...
    [
        ...
        "Piercing Bolts",
        [
            ("crusade_bolt_heavy_pierce", 0),
            ("flying_missile", ixmesh_flying_ammo),
            ("crusade_bolt_bag_heavy_pierce", ixmesh_carry),
        ],
        itp_type_bolts | itp_merchandise | itp_can_penetrate_shield,
        itcf_carry_quiver_right_vertical,
        210,
    ...
    [
        ...
        "Pilgrim Disguise",
        [("Outcast_Robe_A", 0)],
        0 | itp_type_body_armor | itp_covers_legs | itp_civilian,
        0,
        25,
        weight(2)
        | abundance(100)
    ...
    [
        ...
        "Pilgrim Hood",
        [("Pilgrim_Hood_A", 0)],
        0 | itp_type_head_armor | itp_civilian,
        0,
        35,
        weight(1.25)
        | abundance(100)
    ...
    [
        ...
        [("Leather_Gloves_A_L", 0)],
        itp_merchandise | itp_type_hand_armor,
        0,
        60,
        weight(0.25) | abundance(100) | body_armor(1) | difficulty(0),
        imodbits_cloth,
    ],
    [
        "leather_gloves_a_v1",
        "Leather Gloves",
        [("Leather_Gloves_A_v1_L", 0)],
        itp_merchandise | itp_type_hand_armor,
        0,
        90,
        weight(0.25) | abundance(100) | body_armor(2) | difficulty(0),
        imodbits_cloth,
    ],
    [
        "leather_gloves_b",
        "Long Cheap Leather Gloves",
        [("Leather_Gloves_B_L", 0)],
        itp_merchandise | itp_type_hand_armor,
        0,
        120,
        weight(0.3) | abundance(100) | body_armor(3) | difficulty(0),
        imodbits_cloth,
    ],
    [
        "leather_gloves_b_v1",
        "Long Leather Gloves",
        [("Leather_Gloves_B_v1_L", 0)],
        itp_merchandise | itp_type_hand_armor,
        0,
        150,
        weight(0.3) | abundance(100) | body_armor(4) | difficulty(0),
        imodbits_cloth,
    ],
    [
        "mail_mittens_a",
        ...
        0,
        150,
        weight(0.5) | abundance(100) | body_armor(4) | difficulty(8),
        imodbits_armor,
    ],
    [
        "mail_mittens_a_v1",
        "Mail Mittens",
        [("Mail_Gloves_A_v1_L", 0)],
        itp_merchandise | itp_type_hand_armor,
        0,
        180,
        weight(0.5) | abundance(100) | body_armor(5) | difficulty(9),
        imodbits_armor,
    ],
    [
        "plate_gauntlets_a",
        "Cheap Plate Gauntlets",
        [("Plate_Gauntlets_A_L", 0)],
        itp_merchandise | itp_type_hand_armor,
        0,
        710,
        weight(0.75) | abundance(100) | body_armor(6) | difficulty(10),
        imodbits_armor,
    ],
    [
        "plate_gauntlets_a_v1",
        "Cheap Plate Gauntlets",
        [("Plate_Gauntlets_A_v1_L", 0)],
        itp_merchandise | itp_type_hand_armor,
        0,
        740,
        weight(0.75) | abundance(100) | body_armor(7) | difficulty(10),
        imodbits_armor,
    ],
    [
        "plate_gauntlets_a_v2",
        "Cheap Plate Gauntlets",
        [("Plate_Gauntlets_A_v2_L", 0)],
        itp_merchandise | itp_type_hand_armor,
        0,
        770,
        weight(0.75) | abundance(100) | body_armor(8) | difficulty(11),
        imodbits_armor,
    ],
    [
        "plate_gauntlets_b",
        "Plate Gauntlets",
        [("Plate_Gauntlets_B_L", 0)],
        itp_merchandise | itp_type_hand_armor,
        0,
        840,
        weight(0.85) | abundance(100) | body_armor(8) | difficulty(11),
        imodbits_armor,
    ],
    [
        "plate_gauntlets_b_v1",
        "Plate Gauntlets",
        [("Plate_Gauntlets_B_v1_L", 0)],
        itp_merchandise | itp_type_hand_armor,
        0,
        870,
        weight(0.85) | abundance(100) | body_armor(9) | difficulty(12),
        imodbits_armor,
    ],
    # BOOTS BEGIN
    [
        ...
        "Sandals",
        [("Sandals_A", 0)],
        itp_merchandise | itp_type_foot_armor | itp_attach_armature | itp_civilian,
        0,
        5,
        weight(0.25)
        | abundance(100)
    ...
    [
        "light_leather_boots_a",
        "Light Leather Boots",
        [("Light_Leather_Boots_A", 0)],
        itp_merchandise | itp_type_foot_armor | itp_attach_armature | itp_civilian,
        0,
        87,
        weight(1)
    ...
    [
        "light_leather_boots_a_v1",
        "Light Leather Boots",
        [("Light_Leather_Boots_A_v1", 0)],
        itp_merchandise | itp_type_foot_armor | itp_attach_armature | itp_civilian,
        0,
        87,
        weight(1)
    ...
    [
        "light_leather_boots_b",
        "Light Leather Boots",
        [("Light_Leather_Boots_B", 0)],
        itp_merchandise | itp_type_foot_armor | itp_attach_armature | itp_civilian,
        0,
        87,
        weight(1)
    ...
    [
        "light_leather_boots_b_v1",
        "Light Leather Boots",
        [("Light_Leather_Boots_B_v1", 0)],
        itp_merchandise | itp_type_foot_armor | itp_attach_armature | itp_civilian,
        0,
        87,
        weight(1)
    ...
    [
        "light_leather_boots_c",
        "Light Leather Boots",
        [("Light_Leather_Boots_C", 0)],
        itp_merchandise | itp_type_foot_armor | itp_attach_armature | itp_civilian,
        0,
        87,
        weight(1)
    ...
    [
        "light_leather_boots_c_v1",
        "Light Leather Boots",
        [("Light_Leather_Boots_C_v1", 0)],
        itp_merchandise | itp_type_foot_armor | itp_attach_armature | itp_civilian,
        0,
        87,
        weight(1)
    ...
    [
        ...
        "Mail Boots",
        [("Mail_Boots_A", 0)],
        itp_merchandise | itp_type_foot_armor | itp_attach_armature,
        0,
        297,
        weight(2)
        | abundance(100)
    ...
    [
        ...
        "Lady Dress",
        [("lady_dress_r", 0)],
        itp_type_body_armor | itp_covers_legs | itp_civilian,
        0,
        500,
        weight(3)
        | abundance(100)
    ...
    [
        ...
        "Khergit Leather Lady Dress",
        [("khergit_lady_dress_b", 0)],
        itp_type_body_armor | itp_covers_legs | itp_civilian,
        0,
        500,
        weight(3)
    ...
    [
        ...
        0,
        650,
        weight(16) | abundance(100) | head_armor(0) | body_armor(39) | leg_armor(8),
        imodbits_armor,
    ],
    [
        "mail_with_tunic_green",
        "Mail with Tunic",
        [("Arena_Armor_Green", 0)],
        itp_type_body_armor | itp_covers_legs,
        0,
    ...
    [
        "dark_padded_cloth_a_v1",
        "Padded Cloth with Leather",
        [("Padded_Cloth_Revised_A_v1", 0)],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        356,
        weight(13)
    ...
    [
        "menegras_aketon_b",
        "Menegras House Aketon with Kneekops",
        [("Aketon_Menegras_B", 0)],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        489,
    ...
    [
        "menegras_brigandine_a",
        "Menegras House Brigandine",
        [("Brigandine_Menegras_A", 0)],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        899,
        weight(21)
    ...
    [
        "menegras_brigandine_b",
        "Menegras House Brigandine on Mail",
        [("Brigandine_Menegras_B", 0)],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1299,
        weight(25)
    ...
    [
        "menegras_brigandine_c",
        "Menegras House Brigandine With Plates",
        [("Brigandine_Menegras_C", 0)],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1399,
        weight(24)
    ...
    [
        "menegras_brigandine_d",
        "Menegras House Heavy Brigandine",
        [("Brigandine_Menegras_D", 0)],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1671,
        weight(26)
    ...
    [
        "leather_vest_regular_shirt_a",
        "Leather Vest",
        [
            ("Leather_Vest_Regular_Shirt_A", 0),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs | itp_civilian,
        0,
        129,
    ...
    [
        "leather_vest_regular_shirt_a_v1",
        "Outlaw Leather Vest",
        [
            ("Leather_Vest_Regular_Shirt_A_v1", 0),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs | itp_civilian,
        0,
        169,
    ...
    [
        "red_shirt_a_v1",
        "Rich Shirt with Cloak",
        [
            ("Red_Regular_Shirt_A_v1", 0),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs | itp_civilian,
        0,
        55,
    ...
    [
        "black_aketon_a",
        "Black Painted Aketon",
        [
            ("Black_Aketon_A", 0),
            ("Black_Aketon_A_thick", imodbit_thick),
            ("Black_Aketon_A_hardened", imodbit_hardened),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        864,
    ...
    [
        "black_aketon_a_v1",
        "Robe on Black Aketon",
        [
            ("Black_Aketon_A_v1", 0),
            ("Black_Aketon_A_v1_thick", imodbit_thick),
            ("Black_Aketon_A_v1_hardened", imodbit_hardened),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        899,
    ...
    [
        "black_aketon_b",
        "Black Painted Aketon with Plates",
        [
            ("Black_Aketon_B", 0),
            ("Black_Aketon_B_thick", imodbit_thick),
            ("Black_Aketon_B_reinforced", imodbit_reinforced),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1188,
    ...
    [
        ...
        [
            ("Black_Aketon_C", 0),
            ("Black_Aketon_C_hardened", imodbit_hardened),
            ("Black_Aketon_C_reinforced", imodbit_reinforced),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1512,
    ...
    [
        ...
        "Black Surcoat",
        [
            ("Black_Surcoat_Revised_A", 0),
            ("Black_Surcoat_Revised_A_thick", imodbit_thick),
            ("Black_Surcoat_Revised_A_hardened", imodbit_hardened),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1220,
    ...
    [
        "black_coat_of_plates_a",
        "Mail Coat of Plates on Black Aketon",
        [
            ("Black_Aketon_Coat_A", 0),
            ("Black_Aketon_Coat_A_thick", imodbit_thick),
            ("Black_Aketon_Coat_A_reinforced", imodbit_reinforced),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1602,
    ...
    [
        "black_coat_of_plates_a_v1",
        "Mail Coat of Plates on Black Aketon",
        [
            ("Black_Aketon_Coat_A_v1", 0),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1602,
    ...
    [
        "black_coat_of_plates_b",
        "Heavy Mail Coat of Plates on Black Aketon",
        [
            ("Black_Aketon_Coat_B", 0),
            ("Black_Aketon_Coat_B_thick", imodbit_thick),
            ("Black_Aketon_Coat_B_reinforced", imodbit_reinforced),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1893,
    ...
    [
        "black_hauberk_a",
        "Hauberk on Black Painted Aketon",
        [
            ("Black_Hauberk_A", 0),
            ("Black_Hauberk_A_thick", imodbit_thick),
            ("Black_Hauberk_A_reinforced", imodbit_reinforced),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1487,
    ...
    [
        "black_hauberk_b",
        "Plated Hauberk on Black Painted Aketon",
        [
            ("Black_Hauberk_B", 0),
            ("Black_Hauberk_B_thick", imodbit_hardened),
            ("Black_Hauberk_B_reinforced", imodbit_reinforced),
        ],
        itp_merchandise | itp_type_body_armor | itp_covers_legs,
        0,
        1718,
    ...
    [
        "felt_a",
        "Felt Hat",
        [("Revised_Felt_A", 0), ("Revised_Felt_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature | itp_civilian,
        0,
        51,
        weight(0.5)
        | abundance(100)
    ...
    [
        "felt_a_v1",
        "Felt Hat with Feather",
        [("Revised_Felt_A_v1", 0), ("Revised_Felt_A_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature | itp_civilian,
        0,
        51,
        weight(0.5)
    ...
    [
        "felt_a_v2",
        "Felt Hat on Arming Cap",
        [("Revised_Felt_A_v2", 0), ("Revised_Felt_A_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature | itp_civilian,
        0,
        104,
        weight(1)
    ...
    [
        "felt_b",
        "Felt Hat",
        [("Revised_Felt_B", 0), ("Revised_Felt_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature | itp_civilian,
        0,
        51,
        weight(0.5)
    ...
    [
        "felt_b_v1",
        "Felt Hat on Hood",
        [("Revised_Felt_B_v1", 0), ("Revised_Felt_B_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature | itp_civilian,
        0,
        93,
        weight(1)
    ...
    [
        "adventurer_hood_a",
        "Adventurer Hood",
        [("Adventurers_Hood_A", 0), ("Adventurers_Hood_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature | itp_civilian,
        0,
        93,
        weight(1)
    ...
    [
        "hood_a",
        "Brown Hood",
        [("Revised_Hood_A", 0), ("Revised_Hood_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature | itp_civilian,
        0,
        90,
        weight(1)
    ...
    [
        "hood_b",
        "Green Hood",
        [("Revised_Hood_B", 0), ("Revised_Hood_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature | itp_civilian,
        0,
        90,
        weight(1)
    ...
    [
        "arming_cap_a",
        "Arming Cap",
        [("Revised_Arming_Cap_A", 0), ("Revised_Arming_Cap_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        104,
        weight(1)
        | abundance(100)
    ...
    [
        "padded_coif_a",
        "Padded Coif",
        [("Revised_Padded_Coif_A", 0), ("Revised_Padded_Coif_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        156,
        weight(1)
    ...
    [
        ...
        "Padded Coif on Hood",
        [
            ("Revised_Padded_Coif_A_v1", 0),
            ("Revised_Padded_Coif_A_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        209,
    ...
    [
        "padded_coif_b",
        "Padded Coif",
        [("Revised_Padded_Coif_B", 0), ("Revised_Padded_Coif_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        156,
        weight(1)
    ...
    [
        ...
        "Padded Coif on Hood",
        [
            ("Revised_Padded_Coif_B_v1", 0),
            ("Revised_Padded_Coif_B_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        209,
    ...
    [
        "mail_coif_a",
        "Mail Coif",
        [("Revised_Mail_Coif_A", 0), ("Revised_Mail_Coif_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        222,
        weight(1.5)
    ...
    [
        "mail_coif_a_v1",
        "Mail Coif & Arming Cap",
        [
            ("Revised_Mail_Coif_A_v1", 0),
            ("Revised_Mail_Coif_A_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        243,
    ...
    [
        ...
        "Mail Coif & Hood",
        [
            ("Revised_Mail_Coif_A_v2", 0),
            ("Revised_Mail_Coif_A_v2_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        285,
    ...
    [
        "mail_coif_a_v3",
        "Mail Coif & Green Hood",
        [
            ("Revised_Mail_Coif_A_v3", 0),
            ("Revised_Mail_Coif_A_v3_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        285,
    ...
    [
        "cervelliere_a",
        "Cervelliere on Arming Cap",
        [("Revised_Cervelliere_A", 0), ("Revised_Cervelliere_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        252,
        weight(1)
    ...
    [
        "cervelliere_a_v1",
        "Cervelliere on Padded",
        [
            ("Revised_Cervelliere_A_v1", 0),
            ("Revised_Cervelliere_A_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        315,
    ...
    [
        ...
        "Cervelliere on Mail",
        [
            ("Revised_Cervelliere_A_v2", 0),
            ("Revised_Cervelliere_A_v2_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        369,
    ...
    [
        ...
        "Cervelliere on Mail",
        [
            ("Revised_Cervelliere_A_v3", 0),
            ("Revised_Cervelliere_A_v3_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        379,
    ...
    [
        "cervelliere_b",
        "Cervelliere on Arming Cap",
        [("Revised_Cervelliere_B", 0), ("Revised_Cervelliere_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        252,
        weight(1)
    ...
    [
        ...
        "Cervelliere on Padded",
        [
            ("Revised_Cervelliere_B_v1", 0),
            ("Revised_Cervelliere_B_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        315,
    ...
    [
        ...
        "Cervelliere on Mail",
        [
            ("Revised_Cervelliere_B_v2", 0),
            ("Revised_Cervelliere_B_v2_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        369,
    ...
    [
        ...
        "Cervelliere on Mail",
        [
            ("Revised_Cervelliere_B_v3", 0),
            ("Revised_Cervelliere_B_v3_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        379,
    ...
    [
        "flat_top_a",
        "Flat Top on Arming Cap",
        [("Revised_Flat_Top_A", 0), ("Revised_Flat_Top_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        315,
        weight(1.5)
    ...
    [
        "flat_top_a_v1",
        "Flat Top on Hood",
        [("Revised_Flat_Top_A_v1", 0), ("Revised_Flat_Top_A_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        347,
        weight(1.5)
    ...
    [
        "flat_top_a_v2",
        "Flat Top on Padding",
        [("Revised_Flat_Top_A_v2", 0), ("Revised_Flat_Top_A_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        390,
        weight(2)
    ...
    [
        "flat_top_a_v3",
        "Flat Top on Mail",
        [("Revised_Flat_Top_A_v3", 0), ("Revised_Flat_Top_A_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        443,
        weight(2.5)
    ...
    [
        "flat_top_a_v4",
        "Flat Top on Mail",
        [("Revised_Flat_Top_A_v4", 0), ("Revised_Flat_Top_A_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        453,
        weight(2.5)
    ...
    [
        "flat_top_b",
        "Flat Top with Noseguard on Arming Cap",
        [("Revised_Flat_Top_B", 0), ("Revised_Flat_Top_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        336,
        weight(1.5)
    ...
    [
        "flat_top_b_v1",
        "Flat Top with Noseguard on Hood",
        [("Revised_Flat_Top_B_v1", 0), ("Revised_Flat_Top_B_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        367,
        weight(1.5)
    ...
    [
        "flat_top_b_v2",
        "Flat Top with Noseguard on Padding",
        [("Revised_Flat_Top_B_v2", 0), ("Revised_Flat_Top_B_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        410,
        weight(1.5)
    ...
    [
        "flat_top_b_v3",
        "Flat Top with Noseguard on Mail",
        [("Revised_Flat_Top_B_v3", 0), ("Revised_Flat_Top_B_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        463,
        weight(1.5)
    ...
    [
        "flat_top_b_v4",
        "Flat Top with Noseguard on Mail",
        [("Revised_Flat_Top_B_v4", 0), ("Revised_Flat_Top_B_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        474,
        weight(1.5)
    ...
    [
        "chapel_a",
        "Chapel",
        [("Revised_Chapel_A", 0), ("Revised_Chapel_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        326,
        weight(1.5)
    ...
    [
        "chapel_a_v1",
        "Chapel on Arming Cap",
        [("Revised_Chapel_A_v1", 0), ("Revised_Chapel_A_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        336,
        weight(1.5)
    ...
    [
        "chapel_a_v2",
        "Chapel on Hood",
        [("Revised_Chapel_A_v2", 0), ("Revised_Chapel_A_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        379,
        weight(2)
    ...
    [
        "chapel_a_v3",
        "Chapel on Padding",
        [("Revised_Chapel_A_v3", 0), ("Revised_Chapel_A_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        433,
        weight(2)
    ...
    [
        "chapel_b",
        "Chapel",
        [("Revised_Chapel_B", 0), ("Revised_Chapel_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        326,
        weight(1.5)
    ...
    [
        "chapel_b_v1",
        "Chapel on Arming Cap",
        [("Revised_Chapel_B_v1", 0), ("Revised_Chapel_B_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        336,
        weight(1.5)
    ...
    [
        "chapel_b_v2",
        "Chapel on Hood",
        [("Revised_Chapel_B_v2", 0), ("Revised_Chapel_B_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        379,
        weight(2)
    ...
    [
        "chapel_b_v3",
        "Chapel on Padding",
        [("Revised_Chapel_B_v3", 0), ("Revised_Chapel_B_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        433,
        weight(2)
    ...
    [
        "chapel_c",
        "Chapel",
        [("Revised_Chapel_C", 0), ("Revised_Chapel_C_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        326,
        weight(1.5)
    ...
    [
        "chapel_c_v1",
        "Chapel on Arming Cap",
        [("Revised_Chapel_C_v1", 0), ("Revised_Chapel_C_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        336,
        weight(1.5)
    ...
    [
        "chapel_c_v2",
        "Chapel on Hood",
        [("Revised_Chapel_C_v2", 0), ("Revised_Chapel_C_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        379,
        weight(2)
    ...
    [
        "chapel_c_v3",
        "Chapel on Padding",
        [("Revised_Chapel_C_v3", 0), ("Revised_Chapel_C_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        433,
        weight(2)
    ...
    [
        ...
        "Chapel",
        [
            ("Revised_Chapel_Alpine_A", 0),
            ("Revised_Chapel_Alpine_A_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        336,
    ...
    [
        ...
        "Chapel on Hood",
        [
            ("Revised_Chapel_Alpine_A_v1", 0),
            ("Revised_Chapel_Alpine_A_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        395,
    ...
    [
        ...
        "Chapel on Padded",
        [
            ("Revised_Chapel_Alpine_A_v2", 0),
            ("Revised_Chapel_Alpine_A_v2_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        453,
    ...
    [
        ...
        "Chapel on Mail",
        [
            ("Revised_Chapel_Alpine_A_v3", 0),
            ("Revised_Chapel_Alpine_A_v3_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        493,
    ...
    [
        "morion_a",
        "Morion",
        [("Revised_Morion_A", 0), ("Revised_Morion_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        326,
        weight(1.5)
    ...
    [
        "morion_a_v1",
        "Morion on Arming Cap",
        [("Revised_Morion_A_v1", 0), ("Revised_Morion_A_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        336,
        weight(1.5)
    ...
    [
        "morion_a_v2",
        "Morion on Hood",
        [("Revised_Morion_A_v2", 0), ("Revised_Morion_A_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        379,
        weight(2)
    ...
    [
        "morion_b",
        "Morion",
        [("Revised_Morion_B", 0), ("Revised_Morion_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        367,
        weight(2)
    ...
    [
        "morion_b_v1",
        "Morion on Arming Cap",
        [("Revised_Morion_B_v1", 0), ("Revised_Morion_B_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        401,
        weight(2)
    ...
    [
        "morion_b_v2",
        "Morion on Hood",
        [("Revised_Morion_B_v2", 0), ("Revised_Morion_B_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        420,
        weight(2.5)
    ...
    [
        "morion_b_v3",
        "Morion on Padding",
        [("Revised_Morion_B_v3", 0), ("Revised_Morion_B_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        441,
        weight(2.5)
    ...
    [
        "morion_b_v4",
        "Morion on Mail",
        [("Revised_Morion_B_v4", 0), ("Revised_Morion_B_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        493,
        weight(3)
    ...
    [
        "morion_b_v5",
        "Morion on Mail",
        [("Revised_Morion_B_v5", 0), ("Revised_Morion_B_v5_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        504,
        weight(3)
    ...
    [
        "eyeslot_kettlehat_a",
        "Kettle Hat",
        [("Revised_Kettlehat_A", 0), ("Revised_Kettlehat_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        336,
        weight(1)
    ...
    [
        "eyeslot_kettlehat_a_v1",
        "Kettle Hat on Arming Cap",
        [
            ("Revised_Kettlehat_A_v1", 0),
            ("Revised_Kettlehat_A_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        347,
    ...
    [
        "eyeslot_kettlehat_a_v2",
        "Kettle Hat on Hood",
        [
            ("Revised_Kettlehat_A_v2", 0),
            ("Revised_Kettlehat_A_v2_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        390,
    ...
    [
        "eyeslot_kettlehat_a_v3",
        "Kettle Hat on Mail",
        [
            ("Revised_Kettlehat_A_v3", 0),
            ("Revised_Kettlehat_A_v3_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        493,
    ...
    [
        "sallet_a",
        "Sallet",
        [("Revised_Sallet_A", 0), ("Revised_Sallet_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        367,
        weight(2)
    ...
    [
        "sallet_a_v1",
        "Sallet on Arming Cap",
        [("Revised_Sallet_A_v1", 0), ("Revised_Sallet_A_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        401,
        weight(2)
    ...
    [
        "sallet_a_v2",
        "Sallet on Hood",
        [("Revised_Sallet_A_v2", 0), ("Revised_Sallet_A_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        420,
        weight(2.5)
    ...
    [
        "sallet_a_v3",
        "Sallet on Padding",
        [("Revised_Sallet_A_v3", 0), ("Revised_Sallet_A_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        441,
        weight(2.5)
    ...
    [
        "sallet_a_v4",
        "Sallet on Mail",
        [("Revised_Sallet_A_v4", 0), ("Revised_Sallet_A_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        493,
        weight(3)
    ...
    [
        "sallet_a_v5",
        "Sallet on Mail",
        [("Revised_Sallet_A_v5", 0), ("Revised_Sallet_A_v5_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        504,
        weight(3)
    ...
    [
        "sallet_b",
        "Sallet with Open Visor",
        [("Revised_Sallet_B", 0), ("Revised_Sallet_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        401,
        weight(2)
    ...
    [
        "sallet_b_v1",
        "Sallet with Open Visor on Arming Cap",
        [("Revised_Sallet_B_v1", 0), ("Revised_Sallet_B_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        441,
        weight(2.5)
    ...
    [
        "sallet_b_v2",
        "Sallet with Open Visor on Hood",
        [("Revised_Sallet_B_v2", 0), ("Revised_Sallet_B_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        465,
        weight(2.5)
    ...
    [
        "sallet_b_v3",
        "Sallet with Open Visor on Padding",
        [("Revised_Sallet_B_v3", 0), ("Revised_Sallet_B_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        496,
        weight(2.5)
    ...
    [
        "sallet_b_v4",
        "Sallet with Open Visor on Mail",
        [("Revised_Sallet_B_v4", 0), ("Revised_Sallet_B_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        517,
        weight(2.5)
    ...
    [
        "sallet_b_v5",
        "Sallet with Open Visor on Mail",
        [("Revised_Sallet_B_v5", 0), ("Revised_Sallet_B_v5_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        528,
        weight(2.5)
    ...
    [
        "sallet_c",
        "Sallet with Closed Visor",
        [("Revised_Sallet_C", 0), ("Revised_Sallet_C_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        441,
        weight(2.5)
    ...
    [
        "sallet_c_v1",
        "Sallet with Closed Visor on Arming Cap",
        [("Revised_Sallet_C_v1", 0), ("Revised_Sallet_C_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        465,
        weight(2.5)
    ...
    [
        "sallet_c_v2",
        "Sallet with Closed Visor on Hood",
        [("Revised_Sallet_C_v2", 0), ("Revised_Sallet_C_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        496,
        weight(2.5)
    ...
    [
        "sallet_c_v3",
        "Sallet with Closed Visor on Padding",
        [("Revised_Sallet_C_v3", 0), ("Revised_Sallet_C_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        517,
        weight(2.5)
    ...
    [
        "sallet_c_v4",
        "Sallet with Closed Visor on Mail",
        [("Revised_Sallet_C_v4", 0), ("Revised_Sallet_C_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        528,
        weight(2.5)
    ...
    [
        "sallet_c_v5",
        "Sallet with Closed Visor on Mail",
        [("Revised_Sallet_C_v5", 0), ("Revised_Sallet_C_v5_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        539,
        weight(2.5)
    ...
    [
        "sallet_d",
        "Sallet",
        [("Revised_Sallet_D", 0), ("Revised_Sallet_D_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        367,
        weight(2)
    ...
    [
        "sallet_d_v1",
        "Sallet on Arming Cap",
        [("Revised_Sallet_D_v1", 0), ("Revised_Sallet_D_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        401,
        weight(2)
    ...
    [
        "sallet_d_v2",
        "Sallet on Hood",
        [("Revised_Sallet_D_v2", 0), ("Revised_Sallet_D_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        420,
        weight(2.5)
    ...
    [
        "sallet_d_v3",
        "Sallet on Padding",
        [("Revised_Sallet_D_v3", 0), ("Revised_Sallet_D_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        441,
        weight(2.5)
    ...
    [
        "sallet_d_v4",
        "Sallet on Mail",
        [("Revised_Sallet_D_v4", 0), ("Revised_Sallet_D_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        493,
        weight(3)
    ...
    [
        "sallet_d_v5",
        "Sallet on Mail",
        [("Revised_Sallet_D_v5", 0), ("Revised_Sallet_D_v5_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        504,
        weight(3)
    ...
    [
        "celestial_sallet_a",
        "Sallet",
        [("Celestial_Sallet_A", 0), ("Celestial_Sallet_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        367,
        weight(2)
    ...
    [
        "celestial_sallet_a_v1",
        "Sallet on Arming Cap",
        [("Celestial_Sallet_A_v1", 0), ("Celestial_Sallet_A_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        401,
        weight(2)
    ...
    [
        "celestial_sallet_a_v2",
        "Sallet on Hood",
        [("Celestial_Sallet_A_v2", 0), ("Celestial_Sallet_A_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        420,
        weight(2.5)
    ...
    [
        "celestial_sallet_a_v3",
        "Sallet on Padding",
        [("Celestial_Sallet_A_v3", 0), ("Celestial_Sallet_A_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        441,
        weight(2.5)
    ...
    [
        "celestial_sallet_a_v4",
        "Sallet on Mail",
        [("Celestial_Sallet_A_v4", 0), ("Celestial_Sallet_A_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        493,
        weight(3)
    ...
    [
        "celestial_sallet_a_v5",
        "Sallet on Mail",
        [("Celestial_Sallet_A_v5", 0), ("Celestial_Sallet_A_v5_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        504,
        weight(3)
    ...
    [
        "celestial_sallet_b",
        "Sallet with Open Visor",
        [("Celestial_Sallet_B", 0), ("Celestial_Sallet_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        401,
        weight(2)
    ...
    [
        "celestial_sallet_b_v1",
        "Sallet with Open Visor on Arming Cap",
        [("Celestial_Sallet_B_v1", 0), ("Celestial_Sallet_B_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        441,
        weight(2.5)
    ...
    [
        "celestial_sallet_b_v2",
        "Sallet with Open Visor on Hood",
        [("Celestial_Sallet_B_v2", 0), ("Celestial_Sallet_B_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        465,
        weight(2.5)
    ...
    [
        "celestial_sallet_b_v3",
        "Sallet with Open Visor on Padding",
        [("Celestial_Sallet_B_v3", 0), ("Celestial_Sallet_B_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        496,
        weight(2.5)
    ...
    [
        "celestial_sallet_b_v4",
        "Sallet with Open Visor on Mail",
        [("Celestial_Sallet_B_v4", 0), ("Celestial_Sallet_B_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        517,
        weight(2.5)
    ...
    [
        "celestial_sallet_b_v5",
        "Sallet with Open Visor on Mail",
        [("Celestial_Sallet_B_v5", 0), ("Celestial_Sallet_B_v5_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        528,
        weight(2.5)
    ...
    [
        "celestial_sallet_c",
        "Sallet with Closed Visor",
        [("Celestial_Sallet_C", 0), ("Celestial_Sallet_C_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        441,
        weight(2.5)
    ...
    [
        "celestial_sallet_c_v1",
        "Sallet with Closed Visor on Arming Cap",
        [("Celestial_Sallet_C_v1", 0), ("Celestial_Sallet_C_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        465,
        weight(2.5)
    ...
    [
        "celestial_sallet_c_v2",
        "Sallet with Closed Visor on Hood",
        [("Celestial_Sallet_C_v2", 0), ("Celestial_Sallet_C_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        496,
        weight(2.5)
    ...
    [
        "celestial_sallet_c_v3",
        "Sallet with Closed Visor on Padding",
        [("Celestial_Sallet_C_v3", 0), ("Celestial_Sallet_C_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        517,
        weight(2.5)
    ...
    [
        "celestial_sallet_c_v4",
        "Sallet with Closed Visor on Mail",
        [("Celestial_Sallet_C_v4", 0), ("Celestial_Sallet_C_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        528,
        weight(2.5)
    ...
    [
        "celestial_sallet_c_v5",
        "Sallet with Closed Visor on Mail",
        [("Celestial_Sallet_C_v5", 0), ("Celestial_Sallet_C_v5_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        539,
        weight(2.5)
    ...
    [
        "celestial_sallet_d",
        "Sallet with Closed Visor on Bevor",
        [("Celestial_Sallet_D", 0), ("Celestial_Sallet_D_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        651,
        weight(3)
    ...
    [
        "celestial_sallet_d_v1",
        "Sallet with Closed Visor on Bevor",
        [("Celestial_Sallet_D_v1", 0), ("Celestial_Sallet_D_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        652,
        weight(3)
    ...
    [
        "yellow_turban_a",
        "Turban",
        [("Yellow_Turban_A", 0), ("Yellow_Turban_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        104,
        weight(1)
    ...
    [
        "yellow_turban_b",
        "Turban",
        [("Yellow_Turban_B", 0), ("Yellow_Turban_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        104,
        weight(1)
    ...
    [
        "yellow_turban_c",
        "Turban",
        [("Yellow_Turban_C", 0), ("Yellow_Turban_C_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        104,
        weight(1)
    ...
    [
        "yellow_turban_chapel_a",
        "Chapel on Turban",
        [
            ("Yellow_Turban_Chapel_A", 0),
            ("Yellow_Turban_Chapel_A_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        356,
    ...
    [
        "yellow_turban_chapel_a_v1",
        "Chapel on Turban",
        [
            ("Yellow_Turban_Chapel_A_v1", 0),
            ("Yellow_Turban_Chapel_A_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        377,
    ...
    [
        "yellow_turban_sallet_a",
        "Sallet on Turban",
        [
            ("Yellow_Turban_Sallet_A", 0),
            ("Yellow_Turban_Sallet_A_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        433,
    ...
    [
        "yellow_turban_sallet_a_v1",
        "Sallet on Turban",
        [
            ("Yellow_Turban_Sallet_A_v1", 0),
            ("Yellow_Turban_Sallet_A_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        453,
    ...
    [
        "solarian_footman_helmet_a",
        "Footman Helmet on Turban",
        [
            ("Solarian_Footman_Helmet_A", 0),
            ("Solarian_Footman_Helmet_A_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        446,
    ...
    [
        "solarian_footman_helmet_a_v1",
        "Footman Helmet on Turban",
        [
            ("Solarian_Footman_Helmet_A_v1", 0),
            ("Solarian_Footman_Helmet_A_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        467,
    ...
    [
        "solarian_footman_helmet_b",
        "Masked Footman Helmet on Padded",
        [
            ("Solarian_Footman_Helmet_B", 0),
            ("Solarian_Footman_Helmet_B_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        519,
    ...
    [
        "solarian_footman_helmet_b_v1",
        "Masked Footman Helmet on Mail",
        [
            ("Solarian_Footman_Helmet_B_v1", 0),
            ("Solarian_Footman_Helmet_B_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        560,
    ...
    # HAIRAKO HELMETS START
    [
        "black_turban_a",
        "Turban",
        [("Black_Turban_A", 0), ("Black_Turban_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        104,
        weight(1)
    ...
    [
        "black_turban_b",
        "Turban",
        [("Black_Turban_B", 0), ("Black_Turban_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        104,
        weight(1)
    ...
    [
        "black_turban_c",
        "Turban",
        [("Black_Turban_C", 0), ("Black_Turban_C_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        104,
        weight(1)
    ...
    [
        "hairako_helmet_a",
        "Hairako Helmet on Turban",
        [("Hairako_Helmet_A", 0), ("Hairako_Helmet_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        328,
        weight(1.5)
    ...
    [
        "hairako_helmet_a_v1",
        "Hairako Helmet on Turban",
        [("Hairako_Helmet_A_v1", 0), ("Hairako_Helmet_A_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        349,
        weight(1.5)
    ...
    [
        "hairako_helmet_a_v2",
        "Hairako Helmet on Hood",
        [("Hairako_Helmet_A_v2", 0), ("Hairako_Helmet_A_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        370,
        weight(1.5)
    ...
    [
        "hairako_helmet_b",
        "Hairako Helmet on Turban",
        [("Hairako_Helmet_B", 0), ("Hairako_Helmet_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        328,
        weight(1.5)
    ...
    [
        "hairako_helmet_b_v1",
        "Hairako Helmet on Turban",
        [("Hairako_Helmet_B_v1", 0), ("Hairako_Helmet_B_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        349,
        weight(1.5)
    ...
    [
        "hairako_helmet_b_v2",
        "Hairako Helmet on Hood",
        [("Hairako_Helmet_B_v2", 0), ("Hairako_Helmet_B_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        370,
        weight(1.5)
    ...
    [
        "hairako_noseguard_helmet_a",
        "Noseguard Helmet on Turban",
        [
            ("Hairako_Helmet_Noseguard_A", 0),
            ("Hairako_Helmet_Noseguard_A_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        405,
    ...
    [
        "hairako_noseguard_helmet_a_v1",
        "Noseguard Helmet on Turban",
        [
            ("Hairako_Helmet_Noseguard_A_v1", 0),
            ("Hairako_Helmet_Noseguard_A_v1_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        426,
    ...
    [
        "hairako_noseguard_helmet_a_v2",
        "Noseguard Helmet on Hood",
        [
            ("Hairako_Helmet_Noseguard_A_v2", 0),
            ("Hairako_Helmet_Noseguard_A_v2_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        447,
    ...
    [
        "hairako_noseguard_helmet_a_v3",
        "Noseguard Helmet on Padding",
        [
            ("Hairako_Helmet_Noseguard_A_v3", 0),
            ("Hairako_Helmet_Noseguard_A_v3_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        468,
    ...
    [
        "hairako_noseguard_helmet_a_v4",
        "Noseguard Helmet on Mail",
        [
            ("Hairako_Helmet_Noseguard_A_v4", 0),
            ("Hairako_Helmet_Noseguard_A_v4_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        489,
    ...
    [
        "hairako_noseguard_helmet_a_v5",
        "Noseguard Helmet on Mail",
        [
            ("Hairako_Helmet_Noseguard_A_v5", 0),
            ("Hairako_Helmet_Noseguard_A_v5_inv", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        510,
    ...
    # ADID HELMETS START
    [
        "adid_footman_helmet_a",
        "Footman Helmet on Turban",
        [("Adid_Footman_Helmet_A", 0), ("Adid_Footman_Helmet_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        446,
        weight(1.5)
    ...
    [
        "adid_footman_helmet_b",
        "Footman Helmet on Turban",
        [("Adid_Footman_Helmet_B", 0), ("Adid_Footman_Helmet_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        467,
        weight(1.5)
    ...
    [
        "adid_footman_helmet_c",
        "Footman Helmet on Hood",
        [("Adid_Footman_Helmet_C", 0), ("Adid_Footman_Helmet_C_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        488,
        weight(1.5)
    ...
    [
        "menegras_sallet_a",
        "Menegras Sallet",
        [("Menegras_Sallet_A", 0), ("Menegras_Sallet_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_civilian | itp_attach_armature,
        0,
        463,
        weight(2)
        | abundance(90)
    ...
    [
        "menegras_sallet_b",
        "Menegras Sallet open Visor",
        [("Menegras_Sallet_B", 0), ("Menegras_Sallet_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_civilian | itp_attach_armature,
        0,
        496,
        weight(2.5)
    ...
    [
        "menegras_sallet_c",
        "Menegras Sallet closed Visor",
        [("Menegras_Sallet_C", 0), ("Menegras_Sallet_C_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_civilian | itp_attach_armature,
        0,
        517,
        weight(2.5)
    ...
    [
        "menegras_kettlehat_a",
        "Menegras Kettle Hat",
        [("Menegras_Kettlehat_A", 0), ("Menegras_Kettlehat_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_civilian | itp_attach_armature,
        0,
        465,
        weight(2)
    ...
    [
        "menegras_chapel_a",
        "Menegras Chapel de Fer",
        [("Menegras_Chapel_A", 0), ("Menegras_Chapel_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_civilian | itp_attach_armature,
        0,
        465,
        weight(2)
    ...
    [
        "menegras_chapel_b",
        "Menegras Chapel de Fer",
        [("Menegras_Chapel_B", 0), ("Menegras_Chapel_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_civilian | itp_attach_armature,
        0,
        465,
        weight(2)
    ...
    [
        "nerpa_sallet_a",
        "Nerpa Sallet on Arming Cap",
        [("Nerpa_Sallet_A", 0), ("Nerpa_Sallet_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        399,
        weight(2)
    ...
    [
        "nerpa_sallet_a_v1",
        "Nerpa Sallet on Hood",
        [("Nerpa_Sallet_A_v1", 0), ("Nerpa_Sallet_A_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        437,
        weight(2.5)
    ...
    [
        "nerpa_sallet_a_v2",
        "Nerpa Sallet on Padding",
        [("Nerpa_Sallet_A_v2", 0), ("Nerpa_Sallet_A_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        493,
        weight(2.5)
    ...
    [
        "nerpa_sallet_a_v3",
        "Nerpa Sallet on Mail",
        [("Nerpa_Sallet_A_v3", 0), ("Nerpa_Sallet_A_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        534,
        weight(2.5)
    ...
    [
        "nerpa_sallet_a_v4",
        "Nerpa Sallet on Mail",
        [("Nerpa_Sallet_A_v4", 0), ("Nerpa_Sallet_A_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        545,
        weight(2.5)
    ...
    [
        "nerpa_sallet_b",
        "Nerpa Sallet with Visor on Hood",
        [("Nerpa_Sallet_B", 0), ("Nerpa_Sallet_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        493,
        weight(2.75)
    ...
    [
        "nerpa_sallet_b_v1",
        "Nerpa Sallet with Visor on Padding",
        [("Nerpa_Sallet_B_v1", 0), ("Nerpa_Sallet_B_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        534,
        weight(2.75)
    ...
    [
        "nerpa_sallet_b_v2",
        "Nerpa Sallet with Visor on Mail",
        [("Nerpa_Sallet_B_v2", 0), ("Nerpa_Sallet_B_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        600,
        weight(2.75)
    ...
    [
        "nerpa_sallet_b_v3",
        "Nerpa Sallet with Visor on Mail",
        [("Nerpa_Sallet_B_v3", 0), ("Nerpa_Sallet_B_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        611,
        weight(2.75)
    ...
    [
        "nasal_helmet_a",
        "Nasal Helmet",
        [("Revised_Nasal_A", 0), ("Revised_Nasal_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        372,
        weight(2)
    ...
    [
        "nasal_helmet_a_v1",
        "Nasal Helmet on Hood",
        [("Revised_Nasal_A_v1", 0), ("Revised_Nasal_A_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        412,
        weight(2.5)
    ...
    [
        "nasal_helmet_a_v2",
        "Nasal Helmet on Padding",
        [("Revised_Nasal_A_v2", 0), ("Revised_Nasal_A_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        465,
        weight(3)
    ...
    [
        "nasal_helmet_a_v3",
        "Nasal Helmet on Mail",
        [("Revised_Nasal_A_v3", 0), ("Revised_Nasal_A_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        493,
        weight(3.5)
    ...
    [
        "nasal_helmet_a_v4",
        "Nasal Helmet on Mail",
        [("Revised_Nasal_A_v4", 0), ("Revised_Nasal_A_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        504,
        weight(3.5)
    ...
    [
        "nasal_helmet_b",
        "Nasal Helmet",
        [("Revised_Nasal_B", 0), ("Revised_Nasal_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        372,
        weight(2)
    ...
    [
        "nasal_helmet_b_v1",
        "Nasal Helmet on Hood",
        [("Revised_Nasal_B_v1", 0), ("Revised_Nasal_B_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        412,
        weight(2.5)
    ...
    [
        "nasal_helmet_b_v2",
        "Nasal Helmet on Padding",
        [("Revised_Nasal_B_v2", 0), ("Revised_Nasal_B_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        465,
        weight(3)
    ...
    [
        "nasal_helmet_b_v3",
        "Nasal Helmet on Mail",
        [("Revised_Nasal_B_v3", 0), ("Revised_Nasal_B_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        493,
        weight(3.5)
    ...
    [
        "nasal_helmet_b_v4",
        "Nasal Helmet on Mail",
        [("Revised_Nasal_B_v4", 0), ("Revised_Nasal_B_v4_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        504,
        weight(3.5)
    ...
    [
        "facemask_a",
        "Facemask Helmet",
        [("Facemask_Helm_A", 0), ("Facemask_Helm_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        424,
        weight(2)
    ...
    [
        "facemask_a_v1",
        "Facemask Helmet on Padding",
        [("Facemask_Helm_A_v1", 0), ("Facemask_Helm_A_v1_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        465,
        weight(2.5)
    ...
    [
        "facemask_a_v2",
        "Facemask Helmet on Mail",
        [("Facemask_Helm_A_v2", 0), ("Facemask_Helm_A_v2_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        506,
        weight(3)
    ...
    [
        "facemask_a_v3",
        "Facemask Helmet on Mail",
        [("Facemask_Helm_A_v3", 0), ("Facemask_Helm_A_v3_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        517,
        weight(3)
    ...
    # NASAL HELMETS END
    # FOREIGNS HELMETS START
    [
        "foreign_helmet_a",
        "Foreign Helmet",
        [("Foreign_Helmet_A", 0), ("Foreign_Helmet_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        624,
        weight(2)
    ...
    [
        "royal_winged_mace_decorated",
        "Decorated Royal Winged Mace",
        [("luc_bronze_mace", 0)],
        itp_type_one_handed_wpn
        | itp_can_knock_down
        | itp_merchandise
        ...
        | spd_rtng(99)
        | weapon_length(78)
        | swing_damage(33, blunt)
        | thrust_damage(0, pierce),
        imodbits_mace,
    ],
    [
        "royal_mace_decorated",
        "Decorated Royal Mace",
        [("luc_maciejowski_mace", 0)],
        itp_type_one_handed_wpn
        | itp_can_knock_down
        | itp_merchandise
        | itp_primary
    ...
    [
        ...
        "Spiked Club",
        [("luc_spiked_club", 0)],
        itp_craftable | itp_type_one_handed_wpn | itp_primary | itp_wooden_parry,
        itc_scimitar | itcf_carry_mace_left_hip,
        83,
        weight(3)
        | difficulty(0)
    ...
    [
        ...
        | itp_wooden_parry
        | itp_unbalanced,
        itc_morningstar | itcf_carry_mace_left_hip,
        305,
        weight(4.5)
        | difficulty(13)
        | spd_rtng(95)
    ...
    [
        ...
        | itp_secondary
        | itp_no_parry,
        itc_dagger | itcf_carry_dagger_front_right,
        23,
        weight(0.75)
        | difficulty(0)
        | spd_rtng(108)
    ...
    [
        ...
        [
            ...
            ("dagger_b", imodbits_good),
            ("dagger_b_scabbard", ixmesh_carry | imodbits_good),
        ],
        itp_craftable
        | itp_type_one_handed_wpn
        | itp_merchandise
    ...
    [
        "scimitar",
        "Scimitar",
        [("scimitar_a", 0), ("scab_scimeter_a", ixmesh_carry)],
        itp_craftable | itp_type_one_handed_wpn | itp_merchandise | itp_primary,
        itc_scimitar | itcf_carry_sword_left_hip | itcf_show_holster_when_drawn,
        210,
        weight(1.5)
        | difficulty(0)
        | spd_rtng(101)
    ...
    [
        "scimitar_b",
        "Elite Scimitar",
        [("scimitar_b", 0), ("scab_scimeter_b", ixmesh_carry)],
        itp_craftable | itp_type_one_handed_wpn | itp_merchandise | itp_primary,
        itc_scimitar | itcf_carry_sword_left_hip | itcf_show_holster_when_drawn,
        290,
        weight(1.5)
    ...
    [
        ...
        "Two Handed Sabre",
        [("khergit_sword_two_handed_a", 0)],
        itp_craftable
        | itp_type_two_handed_wpn
        | itp_merchandise
        | itp_two_handed
        | itp_primary,
        itc_nodachi | itcf_carry_sword_back,
        523,
        weight(2.75)
        | difficulty(10)
        | spd_rtng(96)
    ...
    [
        "khergit_sword_two_handed_b",
        "Two Handed Sabre",
        [("khergit_sword_two_handed_b", 0)],
        itp_craftable
        | itp_type_two_handed_wpn
        | itp_merchandise
        | itp_two_handed
    ...
    [
        ...
        | itp_primary
        | itp_wooden_parry,
        itc_bastardsword | itcf_carry_axe_back,
        200,
        weight(2.80)
        | difficulty(9)
        | spd_rtng(95)
    ...
    [
        ...
        [("mace_long_a", 0)],
        itp_type_polearm | itp_can_knock_down | itp_primary | itp_wooden_parry,
        itc_staff | itcf_carry_axe_back,
        324,
        weight(3)
        | difficulty(0)
    ...
    [
        "military_scythe",
        "Military Scythe",
        [("luc_bohemian_war_scythe", 0), ("spear_c_2-5m", imodbits_bad)],
        itp_craftable
        | itp_type_polearm
        | itp_offset_lance
        | itp_merchandise
    ...
    [
        "crusader_knight_spear_a",
        "Knight Lance",
        [("crusader_knight_spear_a", 0)],
        itp_couchable
        | itp_craftable
        | itp_type_polearm
        | itp_offset_lance
    ...
    [
        "crusader_knight_spear_a_2",
        "Knight Lance Broken",
        [("crusader_knight_spear_a_2", 0)],
        itp_couchable
        | itp_craftable
        | itp_type_polearm
        | itp_offset_lance
        ...
        | spd_rtng(55)
        | weapon_length(170)
        | thrust_damage(5, blunt),
        imodbits_none,
        [],
    ],
    [
        "crusader_knight_spear_b",
        "Knight Lance",
        [("crusader_knight_spear_b", 0)],
        itp_couchable
        | itp_craftable
        | itp_type_polearm
        | itp_offset_lance
    ...
    [
        "crusader_knight_spear_b_2",
        "Knight Lance Broken",
        [("crusader_knight_spear_b_2", 0)],
        itp_couchable
        | itp_craftable
        | itp_type_polearm
        | itp_offset_lance
    ...
    [
        "crusader_knight_spear_a_2_tip",
        "Broken Knight Lance Tip",
        [("crusader_knight_spear_a_1", 0)],
        itp_type_one_handed_wpn | itp_primary,
        itcf_carry_sword_left_hip | itc_longsword,
        31,
        weight(3)
        | abundance(100)
        | spd_rtng(100)
    ...
    # UNSORTED WEAPONS END
    [
        "cleaver_a",
        "Butcher Knife",
        [
            ("mackie_beefsplitter01", 0),
        ],
        itp_craftable | itp_type_one_handed_wpn | itp_merchandise | itp_primary,
        itc_scimitar | itcf_carry_sword_left_hip,
        125,
    ...
    [
        ...
        "Bastard Sword",
        [("mackie_bastard", 0)],
        itp_craftable | itp_type_two_handed_wpn | itp_merchandise | itp_primary,
    ...
    [
        ...
        "Round Plain Shield",
        [
            ("Wooden_Shield_Plain_Revised_A", 0),
        ],
    ...
    [
        "plain_shield_b",
        "Big Round Plain Shield",
        [
            ("Wooden_Shield_Revised_A", 0),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_round_shield,
        90,
    ...
    [
        ...
        "Plain Kite Shield",
        [
            ("Wooden_Shield_Kite_Revised_A", 0),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_kite_shield,
        90,
    ...
    [
        "plain_kite_shield_a_v1",
        "Plain Kite Shield",
        [
            ("Wooden_Shield_Kite_Revised_A_v1", 0),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_kite_shield,
        90,
    ...
    [
        "old_round_square_shield_a",
        "Old Plain Shield",
        [
            ("Wooden_Shield_Square_Revised_A", 0),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_round_shield,
        90,
    ...
    [
        "old_round_square_shield_a_v1",
        "Old Plain Shield",
        [
            ("Wooden_Shield_Square_Revised_A_v1", 0),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_round_shield,
        90,
    ...
    [
        ...
        "Barbette",
        [("barbette_new", 0)],
        itp_merchandise | itp_type_head_armor | itp_civilian | itp_fit_to_head,
        0,
        70,
        weight(0.5)
        | abundance(100)
    ...
    [
        ...
        [
            ("Leather_Cap_A", 0),
            ("Leather_Cap_A.1", 0),
            ("Leather_Cap_A_inv", ixmesh_inventory),
            ("Leather_Cap_A_inv.1", ixmesh_inventory),
        ],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        24,
        weight(1) | abundance(100) | head_armor(15) | body_armor(0) | leg_armor(0),
        imodbits_cloth,
    ],
    [
        "leather_steppe_cap_b",
        "Steppe Cap ",
        [("tattered_steppe_cap_b_new", 0)],
        itp_merchandise | itp_type_head_armor,
        0,
        36,
    ...
    [
        ...
        "Eastern Lady Hat",
        [("khergit_lady_hat", 0)],
        itp_type_head_armor | itp_civilian | itp_doesnt_cover_hair | itp_fit_to_head,
        0,
        1,
        weight(0.5)
        | abundance(100)
    ...
    [
        "khergit_lady_hat_b",
        "Eastern Lady Leather Hat",
        [("khergit_lady_hat_b", 0)],
        itp_type_head_armor | itp_doesnt_cover_hair | itp_fit_to_head | itp_civilian,
        0,
        1,
        weight(0.5)
        | abundance(100)
    ...
    [
        "m_bascinet_a",
        "Bascinet",
        [("Revised_Bascinet_B", 0), ("Revised_Bascinet_B_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        559,
        weight(2)
    ...
    [
        "m_bascinet_b",
        "Visored Bascinet",
        [("Revised_Bascinet_A", 0), ("Revised_Bascinet_A_inv", ixmesh_inventory)],
        itp_merchandise | itp_type_head_armor | itp_attach_armature,
        0,
        659,
        weight(2.5)
    ...
    [
        "great_helmet_heretics",
        "Great Helmet",
        [("Heretics_Helmet_A", 0)],
        itp_merchandise | itp_type_head_armor | itp_covers_head,
        0,
        995,
        weight(2.75)
        | abundance(100)
    ...
    [
        ...
        "Wooden Shield",
        [("shield_round_a", 0)],
        itp_merchandise | itp_type_shield | itp_wooden_parry,
        itcf_carry_round_shield,
        42,
        weight(2) | hit_points(360) | body_armor(1) | spd_rtng(100) | shield_width(50),
        imodbits_shield,
    ],
    [
        "nordic_shield",
        ...
        itcf_carry_round_shield,
        95,
        weight(2) | hit_points(440) | body_armor(1) | spd_rtng(100) | shield_width(50),
        imodbits_shield,
    ],
    [
        "fur_covered_shield",
        ...
        itcf_carry_kite_shield,
        227,
        weight(3.5) | hit_points(600) | body_armor(1) | spd_rtng(76) | shield_width(81),
        imodbits_shield,
    ],
    [
        "steel_shield",
        "Steel Shield",
        [("shield_dragon", 0)],
        itp_merchandise | itp_type_shield,
        itcf_carry_round_shield,
        697,
        weight(4) | hit_points(700) | body_armor(17) | spd_rtng(61) | shield_width(40),
        imodbits_shield,
    ],
    [
        ...
        itcf_carry_round_shield,
        140,
        weight(4) | hit_points(330) | body_armor(16) | spd_rtng(90) | shield_width(40),
        imodbits_shield,
    ],
    [
        ...
        itcf_carry_round_shield,
        80,
        weight(2.5) | hit_points(310) | body_armor(8) | spd_rtng(96) | shield_width(40),
        imodbits_shield,
    ],
    [
        ...
        itcf_carry_round_shield,
        40,
        weight(2) | hit_points(260) | body_armor(3) | spd_rtng(100) | shield_width(40),
        imodbits_shield,
    ],
    [
        "shield_heater_c",
        ...
        itcf_carry_kite_shield,
        277,
        weight(3.5) | hit_points(410) | body_armor(2) | spd_rtng(80) | shield_width(50),
        imodbits_shield,
    ],
    [
        "norman_shield_1",
        ...
        itcf_carry_kite_shield,
        118,
        weight(2.5) | hit_points(480) | body_armor(1) | spd_rtng(82) | shield_width(90),
        imodbits_shield,
    ],
    [
        "norman_shield_2",
    ...
    [
        "m_plain_round_shield_a",
        "Plain Round Shield",
        [("luc_wooden_shield_y", 0)],
        itp_merchandise | itp_type_shield | itp_wooden_parry,
        itcf_carry_round_shield,
        65,
        weight(3) | hit_points(260) | body_armor(8) | spd_rtng(90) | shield_width(50),
        imodbits_shield,
        [],
        [],
    ],
    [
        "m_plain_round_shield_b",
        "Plain Round Shield",
        [("luc_wooden_shield_w", 0)],
        itp_merchandise | itp_type_shield | itp_wooden_parry,
        itcf_carry_round_shield,
        129,
        weight(3) | hit_points(330) | body_armor(9) | spd_rtng(90) | shield_width(50),
        imodbits_shield,
        [],
        [],
    ],
    [
        "m_plain_round_shield_c",
        "Leather Covered Round Shield",
        [("luc_leather_covered_shield_z", 0)],
        itp_merchandise | itp_type_shield | itp_wooden_parry,
        itcf_carry_round_shield,
        349,
        weight(4) | hit_points(400) | body_armor(11) | spd_rtng(90) | shield_width(50),
        imodbits_shield,
        [],
        [],
    ],
    [
        "m_plain_round_shield_d",
        "Leather Covered Round Shield",
        [("luc_leather_covered_shield_3", 0)],
        itp_merchandise | itp_type_shield | itp_wooden_parry,
        itcf_carry_round_shield,
        301,
        weight(4) | hit_points(370) | body_armor(9) | spd_rtng(90) | shield_width(50),
        imodbits_shield,
        [],
        [],
    ],
    [
        "m_plain_round_shield_e",
        "Heavy Plain Round Shield",
        [("luc_heavy_wooden_shield", 0)],
        itp_merchandise | itp_type_shield | itp_wooden_parry,
        itcf_carry_round_shield,
        349,
        weight(4) | hit_points(400) | body_armor(11) | spd_rtng(90) | shield_width(50),
    ...
    [
        ...
        itcf_carry_round_shield,
        26,
        weight(2.5) | hit_points(195) | body_armor(4) | spd_rtng(93) | shield_width(50),
        imodbits_shield,
        [
            (
                ti_on_init_item,
    ...
    [
        ...
        itcf_carry_round_shield,
        210,
        weight(4) | hit_points(350) | body_armor(15) | spd_rtng(84) | shield_width(50),
        imodbits_shield,
        [
            (
                ti_on_init_item,
    ...
    [
        "practice_board_shield",
        "Practice Board Shield",
        [("tableau_shield_pavise", 0)],
        itp_type_shield | itp_cant_use_on_horseback,
        itcf_carry_board_shield,
        370,
        weight(5)
        | hit_points(550)
    ...
    [
        ...
        itcf_carry_round_shield,
        96,
        weight(2) | hit_points(160) | body_armor(8) | spd_rtng(105) | shield_width(40),
        imodbits_shield,
        [
            (
                ti_on_init_item,
    ...
    [
        ...
        itcf_carry_round_shield,
        370,
        weight(3) | hit_points(250) | body_armor(22) | spd_rtng(100) | shield_width(40),
        imodbits_shield,
        [
            (
                ti_on_init_item,
    ...
    [
        "tab_shield_tauria_a",
        "Plain Shield",
        [("tableau_shield_sarranid_a", 0)],
        itp_merchandise | itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        56,
        weight(3)
        | hit_points(280)
    ...
    [
        "player_tab_footman_shield",
        "Plain Footman Shield",
        [("Player_Shield_Veteran_Heraldic", 0)],
        itp_merchandise | itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        120,
        weight(2)
    ...
    [
        "player_tab_footman_shield_reinforced",
        "Reinforced Footman Shield",
        [("Player_Shield_Veteran_Heraldic_Reinforced", 0)],
        itp_merchandise | itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        120,
        weight(2)
    ...
    ###
    [
        "player_oval_shield_a",
        "Oval Shield",
        [("Player_Shield_Oval_A", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_round_shield,
        140,
        weight(2)
        | abundance(100)
    ...
    [
        "player_oval_shield_b",
        "Oval Shield",
        [("Player_Shield_Oval_B", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_round_shield,
        140,
        weight(2)
    ...
    [
        "player_footman_shield_a",
        "Footman Shield",
        [("Player_Shield_Veteran_A", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        845,
        weight(2)
    ...
    [
        "player_footman_shield_b",
        "Footman Shield",
        [("Player_Shield_Veteran_B", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        845,
        weight(2)
    ...
    [
        "player_footman_shield_c",
        "Footman Shield",
        [("Player_Shield_Veteran_C", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        845,
        weight(2)
    ...
    [
        "player_footman_shield_d",
        "Footman Shield",
        [("Player_Shield_Veteran_D", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        845,
        weight(2)
    ...
    [
        "player_footman_shield_kite_a",
        "Footman Shield",
        [("Player_Shield_Kite_A", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        875,
        weight(2)
    ...
    [
        "player_footman_shield_kite_b",
        "Footman Shield",
        [("Player_Shield_Kite_B", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        875,
        weight(2)
    ...
    [
        "player_footman_shield_kite_c",
        "Footman Shield",
        [("Player_Shield_Kite_C", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        875,
        weight(2)
    ...
    [
        "player_footman_shield_kite_d",
        "Footman Shield",
        [("Player_Shield_Kite_D", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_kite_shield,
        875,
        weight(2)
    ...
    [
        "player_oval_eastern_shield_a",
        "Eastern Oval Shield",
        [("Player_Shield_Oval_Eastern_A", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_round_shield,
        530,
        weight(2)
    ...
    [
        "player_oval_eastern_shield_b",
        "Eastern Oval Shield",
        [("Player_Shield_Oval_Eastern_B", 0)],
        itp_type_shield | itp_craftable | itp_wooden_parry,
        itcf_carry_round_shield,
        530,
        weight(2)
    ...
    [
        "swadia_oval_shield_1",
        "Oval Shield",
        [
            ("shields_archer_tripoli_b", 0),
            ("shields_archer_tripoli_d", imodbit_reinforced),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_round_shield,
        70,
    ...
    [
        "swadia_oval_shield_2",
        "Oval Shield",
        [
            ("shields_archer_tripoli_a", 0),
            ("shields_archer_tripoli_c", imodbit_reinforced),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_round_shield,
        70,
    ...
    [
        "swadia_kite_shield_1",
        "Kite Shield",
        [
            ("tripoli_shield_a", 0),
            ("tripoli_shield_b", imodbit_reinforced),
            ("tripoli_shield_e", imodbit_lordly),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_kite_shield,
        205,
    ...
    [
        "swadia_kite_shield_2",
        "Kite Shield",
        [
            ("tripoli_shield_c", 0),
            ("tripoli_shield_d", imodbit_reinforced),
            ("tripoli_shield_e", imodbit_lordly),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_kite_shield,
    ...
    [
        "swadia_footman_shield_1",
        "Footman Shield",
        [
            ("shield_veteran_tripoli_b", 0),
            ("shield_veteran_tripoli_c", imodbit_reinforced),
            ("shield_veteran_tripoli_d", imodbit_lordly),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_kite_shield,
        700,
    ...
    [
        "swadia_footman_shield_2",
        "Footman Shield",
        [("shield_veteran_tripoli_a", 0)],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_kite_shield,
        700,
        weight(2)
    ...
    [
        "swadia_footman_shield_3",
        "Footman Shield",
        [
            ("shield_veteran_tripoli_e", 0),
            ("shield_veteran_tripoli_g", imodbit_reinforced),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_kite_shield,
        700,
    ...
    [
        ...
        "Footman Shield",
        [
            ("shield_veteran_tripoli_f", 0),
            ("shield_veteran_tripoli_h", imodbit_reinforced),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_kite_shield,
        700,
    ...
    [
        "swadia_heater_shield_1",
        "Heater Shield",
        [
            ("shield_knight_tripoli_a", 0),
            ("shield_knight_tripoli_c", imodbit_reinforced),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_kite_shield,
        500,
    ...
    [
        "swadia_heater_shield_2",
        "Heater Shield",
        [
            ("shield_knight_tripoli_b", 0),
            ("shield_knight_tripoli_d", imodbit_reinforced),
        ],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_kite_shield,
        500,
    ...
    [
        "solarian_oval_shield_a",
        "Solarian Oval Shield",
        [("saracin_shield_a", 0)],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_round_shield,
        330,
    ...
    [
        "solarian_oval_shield_f",
        "Solarian Oval Shield",
        [("securiti_caravan_crusader_shield", 0)],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_round_shield,
        330,
        weight(2)
    ...
    [
        "solarian_round_shield_a",
        "Solarian Round Shield",
        [("saracin_shield_c", 0)],
        itp_type_shield | itp_merchandise | itp_wooden_parry,
        itcf_carry_round_shield,
        295,
    ...
    [
        "darts",
        "Darts",
        [("dart_b", 0), ("dart_b_bag", ixmesh_carry)],
    ...
    [
        "war_darts",
        "War Darts",
        [("dart_a", 0), ("dart_a_bag", ixmesh_carry)],
        itp_type_thrown | itp_merchandise | itp_primary,
        itcf_throw_javelin | itcf_carry_quiver_back | itcf_show_holster_when_drawn,
        285,
        weight(5)
    ...
    [
        ...
        "Javelin",
        [("javelin", 0)],
        itp_type_polearm | itp_primary | itp_wooden_parry,
        itc_staff,
        300,
        weight(1)
        | difficulty(0)
    ...
    [
        "throwing_spears",
        "Throwing Spears",
        [("jarid_new_b", 0), ("jarid_new_b_bag", ixmesh_carry)],
        itp_type_thrown | itp_merchandise | itp_primary | itp_next_item_as_melee,
        itcf_throw_javelin | itcf_carry_quiver_back | itcf_show_holster_when_drawn,
        525,
        weight(3)
    ...
    [
        ...
        "Throwing Spear",
        [("jarid_new_b", 0), ("javelins_quiver", ixmesh_carry)],
        itp_type_polearm | itp_primary | itp_wooden_parry,
        itc_staff,
        525,
        weight(1)
    ...
    [
        "jarid",
        "Jarids",
        [("jarid_new", 0), ("jarid_quiver", ixmesh_carry)],
        itp_type_thrown | itp_merchandise | itp_primary | itp_next_item_as_melee,
        itcf_throw_javelin | itcf_carry_quiver_back | itcf_show_holster_when_drawn,
        560,
        weight(2.75)
    ...
    [
        "light_throwing_axes",
        "Throwing Hatchets",
        [("luc_hatchet_g", 0), ("luc_hatchet_g_inv", ixmesh_inventory)],
        itp_type_thrown | itp_merchandise | itp_primary | itp_next_item_as_melee,
        itcf_throw_axe,
        360,
        weight(5)
    ...
    [
        "khergit_bow",
        "Khergit Bow",
        [("khergit_bow", 0), ("khergit_bow_case", ixmesh_carry)],
        itp_type_bow | itp_merchandise | itp_primary | itp_two_handed,
        itcf_shoot_bow | itcf_carry_bowcase_left | itcf_show_holster_when_drawn,
        269,
        weight(1.25)
    ...
    [
        "pistol_a",
        "Flintlock Pistol",
        [("Pistol_Pistolier_A_01", 0)],
        itp_type_pistol | itp_merchandise | itp_primary,
        itcf_shoot_pistol | itcf_reload_pistol | itcf_carry_pistol_front_left,
        1455,
        weight(2.5)
        | difficulty(0)
        | spd_rtng(38)
        | shoot_speed(160)
        | thrust_damage(66, pierce)
        | max_ammo(1)
        | accuracy(65),
        imodbits_none,
        [
    ...
    [
        "light_rifle_a",
        "Flintlock Rifle",
        [("Gun_Empire_Light_Muscket_A_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(2.5)
        | difficulty(0)
        | spd_rtng(38)
    ...
    [
        "light_rifle_b",
        "Rough Flintlock Rifle",
        [("Gun_Empire_Light_Muscket_B_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "light_rifle_c",
        "Hunting Rifle",
        [("Gun_Empire_Light_Muscket_C_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(2.5)
    ...
    [
        "medium_rifle_a",
        "Military Rifle",
        [("Gun_Empire_Medium_Muscket_A_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        2319,
        weight(4.5)
    ...
    [
        "medium_rifle_b",
        "Great Barrel Rifle",
        [("Gun_Empire_Medium_Muscket_B_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "medium_rifle_c",
        "Rifle",
        [("Gun_Empire_Medium_Muscket_C_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "medium_rifle_d",
        "Rifle",
        [("Gun_Empire_Medium_Muscket_D_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "medium_rifle_e",
        "Two Barrel Rifle",
        [("Gun_Empire_Medium_Muscket_E_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "medium_rifle_f",
        "Rifle",
        [("Gun_Empire_Medium_Muscket_F_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "heavy_rifle_a",
        "Rifle",
        [("Gun_Empire_Heavy_Muscket_A_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "heavy_rifle_b",
        "Rifle",
        [("Gun_Empire_Heavy_Muscket_B_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "heavy_rifle_c",
        "Rifle",
        [("Gun_Empire_Heavy_Muscket_C_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "heavy_rifle_d",
        "Rifle",
        [("Gun_Empire_Heavy_Muscket_D_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "heavy_rifle_e",
        "Rifle",
        [("Gun_Empire_Heavy_Muscket_E_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        "heavy_rifle_f",
        "Rifle",
        [("Gun_Empire_Heavy_Muscket_F_P1_01", 0)],
        itp_type_musket | itp_merchandise | itp_primary,
        itcf_shoot_musket | itcf_reload_musket | itcf_carry_crossbow_back,
        891,
        weight(4.5)
    ...
    [
        ...
        "Lyre",
        [("lyre", 0)],
        itp_type_shield | itp_wooden_parry | itp_civilian,
        itcf_carry_bow_back,
        118,
        weight(2.5)
        | hit_points(480)
    ...
    [
        ...
        "Strange Helmet",
        [
            ("Revised_Strange_Helmet_A", 0),
            ("Revised_Strange_Helmet_A_inv", ixmesh_inventory),
        ],
        itp_type_head_armor | itp_attach_armature,
        0,
        824,
        weight(2)
        | abundance(100)
    ...
    [
        "strange_sword",
        "Strange Sword",
        [("katana", 0), ("katana_scabbard", ixmesh_carry)],
        itp_type_two_handed_wpn | itp_primary,
        itc_bastardsword | itcf_carry_katana | itcf_show_holster_when_drawn,
        679,
        weight(2.0)
        | difficulty(9)
        | spd_rtng(108)
    ...
    [
        "strange_great_sword",
        "Strange Great Sword",
        [("no_dachi", 0), ("no_dachi_scabbard", ixmesh_carry)],
        itp_type_two_handed_wpn | itp_two_handed | itp_primary,
        itc_nodachi | itcf_carry_sword_back | itcf_show_holster_when_drawn,
        920,
        weight(3.5)
        | difficulty(11)
        | spd_rtng(92)
    ...
    [
        "strange_short_sword",
        "Strange Short Sword",
        [("wakizashi", 0), ("wakizashi_scabbard", ixmesh_carry)],
        itp_type_one_handed_wpn | itp_primary,
        itc_longsword | itcf_carry_wakizashi | itcf_show_holster_when_drawn,
        321,
        weight(1.25)
        | difficulty(0)
        | spd_rtng(108)
    ...
    [
        ...
        0,
        237,
        weight(2) | abundance(100) | head_armor(16) | body_armor(0) | leg_armor(0),
        imodbits_cloth,
    ],
    [
        "khergit_war_helmet",
        "Khergit War Helmet",
        [("tattered_steppe_cap_a_new", 0)],
    ...
    [
        "khergit_helmet",
        "Khergit Helmet",
        [("khergit_guard_helmet", 0)],
        itp_type_head_armor,
        0,
        361,
        weight(2) | abundance(100) | head_armor(33) | body_armor(0) | leg_armor(0),
        imodbits_cloth,
    ],
    ...
    [
        "khergit_guard_helmet",
        "Khergit Guard Helmet",
        [("lamellar_helmet_a", 0)],
        itp_type_head_armor | itp_merchandise,
        0,
        433,
    ...
    [
        ...
        "Light Leather",
        [("light_leather", 0)],
        itp_type_body_armor | itp_covers_legs | itp_merchandise,
        0,
        352,
        weight(5)
        | abundance(100)
    ...
    [
        "byzantion_helmet_a",
        "Byzantion Helmet",
        [("byzantion_helmet_a", 0)],
        itp_type_head_armor,
        0,
        278,
        weight(2) | abundance(100) | head_armor(20) | body_armor(0) | leg_armor(0),
        imodbits_cloth,
    ],
    [
        "magyar_helmet_a",
    ...
    [
        ...
        "Sipahi Helmet",
        [
            ("securiti_crysader_helm_a", 0),
            ("securiti_crysader_helm_a.1", 0),
            ("securiti_crysader_helm_a_marcet", ixmesh_inventory),
            ("securiti_crysader_helm_a_marcet.1", ixmesh_inventory),
        ],
        itp_type_head_armor | itp_attach_armature,
        0,
        278,
    ...
    [
        ...
        "Rabati",
        [
            ("securiti_crysader_helm_b", 0),
            ("securiti_crysader_helm_b_marcet", ixmesh_inventory),
        ],
        itp_type_head_armor | itp_attach_armature,
        0,
        278,
    ...
    [
        ...
        0,
        1,
        weight(22) | abundance(100) | head_armor(0) | body_armor(1) | leg_armor(1),
        imodbits_armor,
        [
            (
                ti_on_init_item,
    ...
    [
        ...
        0,
        1,
        weight(3) | abundance(100) | head_armor(0) | body_armor(0) | leg_armor(1),
        imodbits_armor,
    ],
    [
        "warhorse_sarranid",
    ...
    [
        ...
        "Heavy Eastern Horse",
        [
            ("saracin_hard_horses_a", 0),
            ("saracin_hard_horses_a", imodbit_heavy | imodbit_spirited),
        ],
    ...
    [
        "saracin_hard_horses_b",
        "Heavy Eastern Horse",
        [
            ("saracin_hard_horses_b", 0),
            ("saracin_hard_horses_b", imodbit_heavy | imodbit_spirited),
        ],
        itp_type_horse | itp_merchandise,
        0,
        5000,
    ...
    [
        "saracin_hard_horses_c",
        "Heavy Eastern Horse",
        [
            ("saracin_hard_horses_c", 0),
            ("saracin_hard_horses_a", imodbit_heavy | imodbit_spirited),
        ],
        itp_type_horse | itp_merchandise,
        0,
    ...
    [
        ...
        "Heavy Eastern Horse",
        [
            ("saracin_hard_horses_d", 0),
            ("saracin_hard_horses_d", imodbit_heavy | imodbit_spirited),
        ],
        itp_type_horse | itp_merchandise,
        0,
        5000,
    ...
    [
        "saracin_hard_horses_a_v1",
        "Heavy Eastern Horse",
        [
            ("saracin_hard_horses_a_v1", 0),
            ("saracin_hard_horses_a_v1", imodbit_heavy | imodbit_spirited),
        ],
        itp_type_horse | itp_merchandise,
        0,
        5000,
    ...
    [
        ...
        "Heavy Eastern Horse",
        [
            ("saracin_hard_horses_b_v1", 0),
            ("saracin_hard_horses_b_v1", imodbit_heavy | imodbit_spirited),
        ],
        itp_type_horse | itp_merchandise,
        0,
        5000,
    ...
    [
        "saracin_hard_horses_d_v1",
        "Heavy Eastern Horse",
        [
            ("saracin_hard_horses_d_v1", 0),
            ("saracin_hard_horses_d_v1", imodbit_heavy | imodbit_spirited),
        ],
        itp_type_horse | itp_merchandise,
        0,
        5000,
    ...
    # Sonyer OSP Items
    [
        "maa_camel_rider_shield_a",
        "Camel Rider Shield",
        [("camel_rider_shield_a", 0)],
        itp_type_shield,
        itcf_carry_round_shield,
        339,
        weight(1.5) | hit_points(540) | body_armor(6) | spd_rtng(90) | shield_width(52),
        imodbits_shield,
        [],
        [fac_kingdom_11, fac_kingdom_6],
    ],
    [
        "maa_camel_rider_shield_b",
        "Camel Rider Shield",
        [("camel_rider_shield_b", 0)],
        itp_type_shield,
        itcf_carry_round_shield,
        339,
        weight(1.5) | hit_points(540) | body_armor(6) | spd_rtng(90) | shield_width(52),
    ...
    [
        "maa_camel_rider_shield_c",
        "Camel Rider Shield",
        [("camel_rider_shield_c", 0)],
        itp_type_shield,
        itcf_carry_round_shield,
        339,
        weight(1.5) | hit_points(540) | body_armor(6) | spd_rtng(90) | shield_width(52),
    ...
    [
        "maa_camel_rider_shield_d",
        "Camel Rider Shield",
        [("camel_rider_shield_d", 0)],
        itp_type_shield,
        itcf_carry_round_shield,
        339,
        weight(1.5) | hit_points(540) | body_armor(6) | spd_rtng(90) | shield_width(52),
    ...
    [
        "maa_camel_rider_shield_e",
        "Camel Rider Shield",
        [("camel_rider_shield_e", 0)],
        itp_type_shield,
        itcf_carry_round_shield,
        339,
        weight(1.5) | hit_points(540) | body_armor(6) | spd_rtng(90) | shield_width(52),
    ...
    [
        "maa_camel_rider_shield_f",
        "Camel Rider Shield",
        [("camel_rider_shield_f", 0)],
        itp_type_shield,
        itcf_carry_round_shield,
        339,
        weight(1.5) | hit_points(540) | body_armor(6) | spd_rtng(90) | shield_width(52),
    ...
    [
        "maa_camel_light_c",
        "Rider's Camel",
        [("bedyin_camel_a", 0), ("bedyin_camel_a.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        1999,
        weight(0)
    ...
    [
        "maa_camel_light_d",
        "Rider's Camel",
        [("bedyin_camel_b", 0), ("bedyin_camel_b.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        1999,
        weight(0)
    ...
    [
        "maa_camel_war_a",
        "War Camel",
        [("bedyin_camel_c", 0), ("bedyin_camel_c.1", 0), ("bedyin_camel_c.2", 0)],
        itp_merchandise | itp_type_horse,
        0,
        2599,
        weight(0)
    ...
    [
        "maa_camel_war_b",
        "War Camel",
        [("bedyin_camel_d", 0), ("bedyin_camel_d.1", 0), ("bedyin_camel_d.2", 0)],
        itp_merchandise | itp_type_horse,
        0,
        2599,
        weight(0)
    ...
    [
        "maa_camel_war_c",
        "War Camel",
        [("bedyin_camel_e", 0), ("bedyin_camel_e.1", 0), ("bedyin_camel_e.2", 0)],
        itp_merchandise | itp_type_horse,
        0,
        2599,
        weight(0)
    ...
    [
        "maa_camel_war_d",
        "War Camel",
        [("bedyin_camel_f", 0), ("bedyin_camel_f.1", 0)],
        itp_merchandise | itp_type_horse,
        0,
        2599,
        weight(0)
    ...
    ##diplomacy begin
    [
        "dplmc_coat_of_plates_red_constable",
        "Constable Coat of Plates",
        [("coat_of_plates_red", 0)],
        itp_unique | itp_type_body_armor | itp_covers_legs | itp_civilian,
        0,
        3828,
        weight(25)
        | abundance(100)
    ...
    [
        ...
        "Knockdown Mace",
        [("flanged_mace", 0)],
        itp_type_one_handed_wpn | itp_can_knock_down | itp_primary | itp_wooden_parry,
        itc_scimitar | itcf_carry_mace_left_hip,
        0,
        weight(3.5)
        | difficulty(0)
    ...
    [
        "disarming_throwing_axe",
        "Disarming Throwing Axe",
        [("throwing_axe_a", 0)],
        itp_type_thrown | itp_primary,
        itcf_throw_axe,
        0,
    ...
    [
        "backstabber",
        "Backstabber",
        [("sword_viking_a_small", 0), ("sword_viking_a_small_scabbard", ixmesh_carry)],
        itp_type_one_handed_wpn | itp_primary,
        itc_longsword | itcf_carry_sword_left_hip | itcf_show_holster_when_drawn,
        0,
        weight(1.25)
    ...
    [
        "restore_health_armour",
        "Restore Health Armour",
        [("samurai_armor", 0)],
        itp_type_body_armor | itp_covers_legs,
        0,
        0,
    ...
    [
        "javelin_bow_ammo",
        "Shooting Javelins",
        [("javelin_bow_ammo", 0), ("javelins_quiver_new", ixmesh_carry)],
        itp_type_arrows | itp_default_ammo,
        itcf_carry_quiver_back,
        0,
        weight(4) | thrust_damage(34, pierce) | max_ammo(15) | weapon_length(75),
        0,
    ],
