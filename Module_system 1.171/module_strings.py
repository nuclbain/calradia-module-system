...
# Ryan END
 ...
 When you wish to leave this or any other area or retreat from a battle, you can press the TAB key."),
  ...
  ("custom_battle_1", "{!}Lord Haringoth of Silver Rose is travelling with his household knights when he spots a group of raiders preparing to attack a small hamlet.\
 ...
 and spotting the new threat, they decide to combine their forces."),
  ("custom_battle_3", "{!}Lady Brina is leading the defense of her castle against a Silver Rose army.\
...
# meet_spy_in_enemy_town quest secret sentences
  ...
  ("secret_sign_2",  "I am selling these fine Celestial tapestries. Would you like to buy some?"),
...
#npc16 = klethi
  ...
  ("npc1_intro", "Greetings, good {sir/madame}. Let's have a drink together, shall we?"),
  ("npc2_intro", "Greetings, noble traveler. Are you in search of a companion for your journey?"),
  ("npc3_intro", "Ah, a friendly face! I've been wandering alone for quite some time. What brings you to this path, {sir/madame}?"),
  ("npc4_intro", "Do you think there's a chance for redemption for someone like me?"),
  ("npc5_intro", "Might you be the one I've been seeking?"),
  ("npc6_intro", "It's not every day you meet someone destined for greatness, is it?"),
  ("npc7_intro", "Greetings, stranger. You might find my presence curious, for I carry the weight of memories that are not my own."),
  ("npc8_intro", "Greetings, traveler. I see you're not one to shy away from the path of the unknown, and neither am I."),
  ("npc9_intro", "Greetings, traveler. Might you be interested in hearing the tales of a seasoned soldier?"),
  ("npc10_intro", "Well, look who we've got here. A curious soul, or are you just lost?"),
  ("npc11_intro", "Pardon me, kind traveler. I can't help but notice your face. Have you, by any chance, come across someone who looks like me, someone who might be my sister?"),
  ("npc12_intro", "Well, well, well, who do we have here? You look like someone who's seen a bit of the world. What's your game, stranger?"),
  ("npc13_intro", "Greetings, traveler. You seem like you've walked a path filled with tales and wonders. Care to share a moment with an old samurai?"),
  ("npc14_intro", "Well met, stranger. I don't often cross paths with new faces. What brings you to this corner of the world?"),
  ("npc15_intro", "Hail, stranger. I've got a peculiar proposition for you. Ever considered the untapped potential in corpses? The thrill of life and death combined?"),
  ("npc16_intro", "Greetings, stranger. Have you happened upon my... well, I can't remember what it is, but I'm missing something, something very important. Have you seen it?"),

  ("npc1_intro_response_1", "Hey there, traveler. I see you're well-armed and battle-scarred. What brings you to these lands?"),
  ("npc2_intro_response_1", "Hmm... I'm looking for someone of honor and virtue, much like yourself."),
  ("npc3_intro_response_1", "I'm still deciding, but your company might be just what I need."),
  ("npc4_intro_response_1", "Redemption is a difficult path, but it's never too late. What do you seek to redeem?"),
  ("npc5_intro_response_1", "It depends on who you're looking for."),
  ("npc6_intro_response_1", "Fame and glory are admirable pursuits. Tell me more about your aspirations."),
  ("npc7_intro_response_1", "Memories that aren't your own?"),
  ("npc8_intro_response_1", "Indeed, the unknown has its own allure. What is it that you seek?"),
  ("npc9_intro_response_1", "Of course, I'm always keen to hear the stories of experienced individuals. Please, go on."),
  ("npc10_intro_response_1", "I'm always up for a chat. What's your story?"),
  ("npc11_intro_response_1", "I'm afraid I haven't seen anyone who resembles you. Tell me more about your sister and why you're searching for her."),
  ("npc12_intro_response_1", "I'm always up for an interesting conversation. What's your story?"),
  ("npc13_intro_response_1", "Old samurai? You don't look that old to me. What brings you to these lands?"),
  ("npc14_intro_response_1", "Just passing through... But I'm always up for a chat. What's your story?"),
  ("npc15_intro_response_1", "You're sounding rather mad, but I'm curious. What's your deal?"),
  ("npc16_intro_response_1", "What are you looking for?"),

  ("npc1_intro_response_2", "Thanks, but I'm not looking for company."),
  ("npc2_intro_response_2", "I'm not sure, to be honest. I'm evaluating my options."),
  ...
  ("npc9_intro_response_2", "I'm afraid I don't have time for stories at the moment. Goodbye."),
  ("npc10_intro_response_2", "I'm not here for idle chatter. Goodbye."),
  ("npc11_intro_response_2", "No, I haven't. Good day to you."),
  ("npc12_intro_response_2", "I'm just passing through. I don't have time for idle chatter. Goodbye."),
  ("npc13_intro_response_2", "I'm in a hurry, and I don't have time for stories. Farewell."),
  ("npc14_intro_response_2", "I'm in a rush, and I don't have time for small talk. Farewell."),
  ("npc15_intro_response_2", "I've heard enough. I'm not interested in your madness. Farewell."),
  ("npc16_intro_response_2", "I haven't seen your missing item, but I wish you luck in finding it."),

#backstory intro
  ("npc1_backstory_a", "Survival, {sir/madame}. It's been a life of blood and betrayal. As for these scars, they're souvenirs of the countless battles I've fought."),
  ("npc2_backstory_a", "Ah, honor and virtue, guiding stars in the dark of night. I am Mesym, a humble warrior sworn to the cause of good."),
  ("npc3_backstory_a", "You're kind to say so. I'm Evel Droby, an illusionist by trade. My story is a complex one. You see, I carry a traumatic fear of mirrors. A childhood incident left me haunted by the reflections that weren't my own."),
  ("npc4_backstory_a", "My name is Ilhan, a warrior by trade, though not one to boast of my past."),
  ("npc5_backstory_a", "I am Gyliam Gare, a gunslinger by trade, though my true aspiration lies elsewhere. You see, I carry a dream in my heart – a dream of becoming a knight of the realm."),
  ("npc6_backstory_a", "I am Ames, a humble merchant by trade, though my heart burns with a desire for something more. I seek the path of fame and glory, a journey that will etch my name into the annals of history."),
  ("npc7_backstory_a", "I am Malia Willey, a simple commoner burdened with the echoes of a life lived long before my time. Fragments of battles, distant lands, and long-lost loves cloud my thoughts, as if the essence of another soul lingers within me."),
  ("npc8_backstory_a", "I am Eryet Allard, an adept in the art of alchemy. My journey is one of exploration and discovery, for I seek to unravel the mysteries of the natural world, one potion at a time."),
  ("npc9_backstory_a", "My life has been one of service and battles. I served in the ranks of the Royal Guard, defending our kingdom from threats both foreign and domestic. I've seen the horrors of war and the camaraderie that blooms on the battlefield."),
  ("npc10_backstory_a", "I've spent most of my life wandering, from one dusty town to another, with the smell of gunpowder always in the air. I'm a gunslinger, you see, and I live by the code of the gun, or at least what's left of it."),
  ("npc11_backstory_a", "My sister, Elara, and I are twins, as alike as two peas in a pod. She possesses the same silver hair and large grey eyes that I do. We were inseparable until she was taken from me years ago."),
  ("npc12_backstory_a", "My life's been a series of gambles and risks. You see, I'm a gunslinger, a sharpshooter of sorts, but I've always lived by my own rules. I've been in tight spots more times than I can count, and every time, I've come out ahead."),
  ("npc13_backstory_a", "My life has been unlike any other, for I was cursed to spend a century imprisoned by a powerful magic. I watched as the world changed around me, and my once-proud clan faded into history."),
  ("npc14_backstory_a", "My life's been a series of twists and turns. I've been a craftsman, a wanderer, and more. One thing that's never left me is this scar on my neck—a reminder of a close call."),
  ("npc15_backstory_a", "Life and death, they're my playthings. I dabble in necromancy, you see. Unearthing secrets, experimenting with cadavers, and toying with the very fabric of existence."),
  ("npc16_backstory_a", "I've always been forgetful. It's a curse, really. But this time, I've misplaced something that's vital to me, and I can't continue my journey without it."),

#backstory main body
  ("npc1_backstory_b", "I've got a story that'd chill your bones. I was once part of a ruthless band of mercenaries. We roamed the realm, taking what we wanted. But then, a betrayal within our ranks left me wounded and left for dead."),
  ("npc2_backstory_b", "My journey began in a remote village, where I witnessed the devastation wrought by darkness. I took up the arms to protect those who cannot protect themselves."),
  ("npc3_backstory_b", "It all began when I was just a child. My family lived in a quaint cottage in a peaceful village. One fateful night, a malevolent spirit infiltrated our home, possessing a large ornate mirror that had been in our family for generations. The mirror, once a cherished heirloom, transformed into a portal to a realm of darkness."),
  ("npc4_backstory_b", "You see, I once walked a dark path, making choices I now regret. In my youth, I was ensnared by a group of ruthless bandits. The lure of wealth and power led me to commit deeds that haunt my dreams to this day..."),
  ("npc5_backstory_b", "My journey began when I witnessed a valiant knight rescue my village from a bandit raid. His bravery, his unwavering sense of duty, it inspired me deeply. I knew from that moment on that I wanted to dedicate my life to the chivalric code and become a protector of the realm."),
  ("npc6_backstory_b","My journey began when I stumbled upon a book of legends and tales from distant lands. The heroes and heroines within those pages, their stories of valor and renown, awakened something in me. I yearn to become a legend in my own right, to be remembered for ages to come."),
  ("npc7_backstory_b", "I have embraced these memories, seeking to understand the purpose they serve. Perhaps there is a quest, a destiny yet unfulfilled, waiting for me to uncover. Or maybe, in the threads of these past lives, lies a lesson for this one."),
  ("npc8_backstory_b", "Through meticulous experimentation, I've unveiled the secrets of potions and concoctions that can mend wounds, heighten the senses, or even ignite the flames of courage. But there are mysteries yet to be unraveled, and I believe that a grander adventure awaits me."),
  ("npc9_backstory_b", "However, my time in the guard came to an end when I stumbled upon a powerful artifact during a mission. It led to an internal conflict within the kingdom, and I found myself on the wrong side of the struggle. I decided to leave and wander the lands, seeking redemption for my actions."),
  #SB : removed space after s19
  ("npc10_backstory_b", "There's no grand tale of valor for me. Just a wanderer trying to make a living in a world that's gone mad. But I've seen my fair share of strange sights and walked through the ruins of more towns than I can count."),
  ("npc11_backstory_b", "We were living peaceful lives in a small village until a band of marauders attacked. They kidnapped Elara and left me wounded. I've traveled far and wide, hoping to reunite with her, to bring back the warmth that was stolen from my life."),
  ("npc12_backstory_b", "I've walked the line between lawman and outlaw, never really settling in one camp. It's a tough way to live, but it's also the way that's kept me alive."),
  ("npc13_backstory_b", "It was not until recently that I was freed from my magical prison, and I find myself alone in a world I barely recognize. The honor of my samurai code still burns within me, and I seek to find my place in this new age."),
  ("npc14_backstory_b", "I've wandered far and wide, but I've found myself in need of a purpose. I've always been erratic, but I value honesty above all else. I say what's on my mind."),
  #SB : replace cash with silver
  ("npc15_backstory_b", "I'm in search of a companion who frequently treads into the chaos of battle. Fresh corpses make the best subjects for my experiments, don't you think? The more chaotic, the better."),
  ("npc16_backstory_b", "I'm searching for a companion who might help me locate my lost item. I'm convinced it's close by, but my memory... it fails me."),

#backstory recruit pitch
  ("npc1_backstory_c", "Revenge is my only purpose now. The one who betrayed me, who left me for dead, they're out there somewhere, and they'll pay for what they've done."),
  ("npc2_backstory_c", "I have been on the road ever since, seeking out evil and destroying it wherever I find it."),
  ("npc3_backstory_c", "I awoke one night to whispers and eerie lights. Drawn by curiosity, I stood before the mirror, only to see my own reflection slowly contort into something monstrous. It was as if a malevolent force sought to pull me into the glass and take my place in the real world. The terror I felt that night has never truly left me."),
  ("npc4_backstory_c", "It was a life of lawlessness, filled with theft, violence, and suffering. But in a fateful moment, as I gazed into the eyes of a victim whose life I'd shattered, I realized the abyss of my actions. It was then that I knew I had to escape that life and find a way to seek redemption."),
  ("npc5_backstory_c", "I've trained tirelessly, learned the ways of honor and justice, and I've sought out quests that align with the principles of knighthood. But my journey is not complete, and I'm in need of a worthy cause to champion. Might you have need of a companion on your travels, {sir/madame}?"),
  ("npc6_backstory_c", "I've set out to seek grand adventures, to prove my worth in the face of formidable challenges, and to leave a lasting mark on the world. Might you have need of a companion on your travels, {sir/madame}?"),
  ("npc7_backstory_c", "I possess a strength born from the amalgamation of these experiences. Skills from forgotten lives have surfaced, granting me proficiency in combat and an uncanny ability to read people. If you would have me, I am willing to join your journey and explore the mysteries of these haunted memories."),
  ("npc8_backstory_c", "I carry with me a wealth of knowledge and a repertoire of alchemical creations. My skills can mend injuries, enhance our abilities, and provide solutions to unexpected challenges. With your permission, I would be honored to join you on your journey."),
  ("npc9_backstory_c", "But now, I find myself yearning for a new purpose. I can't simply wander forever. Would you consider allowing me to join your group on your journey? I can lend my skills as a soldier to your cause."),
  ("npc10_backstory_c", "I've got a quick hand and an eye for trouble, and it seems you could use someone like me around. So, what do you say? You in need of a gunslinger to watch your back?"),
  ("npc11_backstory_c", "Despite my humble origins, I possess a keen eye and a deep connection to the natural world. I've honed my skills at survival and have a knack for deciphering signs and trails. If you allow me to accompany you, I promise to assist in any way I can."),
  ("npc12_backstory_c", "So, what do you think? You look like you could use someone like me around. I've got a quick eye and a faster trigger finger. Are you interested in having a gunslinger watch your back?"),
  ("npc13_backstory_c", "I am a skilled warrior, trained in the way of the samurai. Would you consider allowing me to join your group? I may be a relic of the past, but I have much to offer."),
  ("npc14_backstory_c", "If you're in need of someone to travel with, I'm willing to join your group. I'm no warrior, but I can craft and repair gear and offer my honest opinion when it's needed."),
  ("npc15_backstory_c", "So, are you brave enough to join me on this twisted journey? Together, we can unlock the darkest powers and test the limits of sanity."),
  ("npc16_backstory_c", "If you're willing to help me find my lost item, I'd gladly travel with you. Perhaps together, we can uncover its whereabouts."),
...
### use these if there is a short period of time between the last meeting
  ...
  ("npc1_backstory_response_1", "Do you want to join us? But I need to know that your vengeance won't lead to trouble for our group."),
  ("npc2_backstory_response_1", "I appreciate your commitment, Mesym. But are you always so gentle?"),
  ("npc3_backstory_response_1", "Such a traumatic experience must have been dreadful. You have my sympathy."),
  ("npc4_backstory_response_1", "Your past may be dark, but your desire for redemption is evident. I'm intrigued, but can you truly leave your past behind?"),
  ("npc5_backstory_response_1", "A gunslinger aspiring to be a knight? Ahahah! That's an unusual path. You're welcome to join us."),
  ("npc6_backstory_response_1", "I'm intrigued, but I'd like to know more about your skills and what you can bring to our journey."),
  ("npc7_backstory_response_1", "Your unique perspective could prove invaluable. I welcome you to our group, Malia."),
  ("npc8_backstory_response_1", "Your knowledge of alchemy is intriguing. I'd like to know more about your skills before making a decision."),
  ("npc9_backstory_response_1", "I'm not sure if I can trust you yet, Aduhash. I'll think it over and let you know."),
  ("npc10_backstory_response_1", "Your skills could come in handy. You're welcome to join us."),
  ("npc11_backstory_response_1", "Your determination and skills make you a valuable companion, Jane. You're welcome to join us."),
  ("npc12_backstory_response_1", "Your skills could be an asset to our group. You're welcome to join."),
  ...
  ("npc16_backstory_response_1", "I'll assist you in finding your missing item, Kina. Let's see if we can jog your memory."),

  ("npc1_backstory_response_2", "I'm sorry, but I can't take on any new hands right now."),
  ("npc2_backstory_response_2", "I see. Well, I wish you luck in your quest."),
  ("npc3_backstory_response_2", "Portals to other realms? ... I'm sorry, but I don't think I can help you."), 
  ("npc4_backstory_response_2", "Some things can't be forgiven. Good day to you."),
  ("npc5_backstory_response_2", "I'm sorry, but I can't help you."),
  ("npc6_backstory_response_2", "I have no need for a merchant, but I wish you luck in your quest."),
  ("npc7_backstory_response_2", "Actually, I'm rather fond of the place. Good day to you."),
  ("npc8_backstory_response_2", "Currently, I have no need for an alchemist. Good day to you."),
  ("npc9_backstory_response_2",  "I appreciate your offer, but I can't have you in my group."),
  ("npc10_backstory_response_2", "I appreciate the offer, but I don't think you're what we need right now."),
  ("npc11_backstory_response_2", "I'm sorry, but I can't help you in your search for your sister. I wish you the best of luck."),
  ...
  ("npc15_backstory_response_2", "I can't condone your madness. I want nothing to do with your chaotic experiments."),
  ("npc16_backstory_response_2", "I'm sorry, but I can't help with your absent-minded search."),

  ("npc1_signup", "{Sir/Madame}, I assure you, my vengeance is my burden alone."),
  ("npc2_signup", "I am, indeed, gentle by nature, but there's a touch of caprice in my soul. A spark of unpredictability, a reminder that even the just must embrace life's mysteries. You see, in my early days as a paladin, I once encountered a humble beggar who sought shelter on a stormy night. I offered him warmth and refuge in the name of goodness, but as the night unfolded, I discovered he was no ordinary beggar. He was a storyteller, a weaver of tales, and his words were like magic, painting vivid landscapes of distant lands and fantastical adventures."),
  ("npc3_signup", "Thank you, {sir/madame}. Together, we can overcome any obstacle, even the shadows of our past. What do you think?"),
  ("npc4_signup", "I understand your skepticism, {sir/madame}. Leaving behind one's past is a challenging journey, but it's one I'm fully committed to."),
  ("npc5_signup", "That's right, {sir/madame}. I've trained in the ways of chivalry, and I'm ready to prove myself in battle."),
  ("npc6_signup", "A fair question, {sir/madame}. While I may not be a seasoned warrior or a powerful spellcaster, I possess a few valuable skills that could benefit our journey. I have a keen eye for details, which makes me adept at spotting hidden treasures, traps, and valuable artifacts."),
  ("npc7_signup", "Thank you for your open-hearted acceptance."),
  ("npc8_signup", "Of course, {sir/madame}. Allow me to shed some light on the nature of my alchemical abilities. I have mastered the creation of a variety of elixirs and concoctions that can serve us well on our journey."),
  ("npc9_signup", "As a soldier, I possess combat skills and tactical knowledge that can be an asset to your group. I can keep us safe on our travels and offer my insights in challenging situations. My commitment to atoning for my past deeds drives me to be the best protector I can be."),
  ("npc10_signup", "As a gunslinger, I've honed my skills with a musket and a quick draw. I can provide cover fire and keep trouble at bay. I might have a brash attitude, but I'm a reliable hand in a tight spot. You won't regret having me on your side."),
  ("npc11_signup", "I should emphasize that despite my humble background, my connection to the natural world has granted me abilities that can prove highly beneficial. I possess a keen eye for detail, enabling me to uncover hidden signs and paths that might elude others."),
  ("npc12_signup", "As a gunslinger, I'm a crack shot with a musket. I can hit a target from a distance that others can't even see. Whether it's cover fire or precision shooting, I've got the skills you need."),
  ("npc13_signup", "As a samurai, I bring not only martial skill but a code of honor. I am skilled in the use of the sword and can hold my own in battle. My loyalty is unwavering, and I will stand by your side through thick and thin."),
  ("npc14_signup", "I would be pleased to ride with you, at least for a little while, for pay and a share of any loot."),
  ("npc15_signup", "My madness transcends mere necromancy. I can raise the fallen and turn them into our twisted allies. Imagine the chaos we can sow on the battlefield!"),
  ("npc16_signup", "I may be forgetful, but I'm a capable warrior. With my skills, I can help you face the challenges of our journey."),

  ("npc1_signup_2", "I'll be an asset to your group. I've got a keen eye for battle strategy and an unbreakable will."),
  ("npc2_signup_2", "As I listened to his tales, my heart danced with joy, and I realized that there's a certain enchantment in unpredictability, in the joy of not always knowing what lies ahead. It was in that moment that I embraced the capricious spark within me, recognizing that even in the path of righteousness, there's room for wonder, surprise, and a touch of whimsy. Life is a grand story, and I intend to fill its pages with both goodness and the unexpected."),
  ("npc3_signup_2", "I'm guided by a heart that seeks to do good and protect those in need. I believe that, with your companionship, we can face any challenge together."),
  ("npc4_signup_2", "Every day, I strive to make amends for the darkness I once embraced and protect those who need it. With your companionship and guidance, I hope to prove that a new path can be forged, even from the darkest of pasts."),
  ("npc5_signup_2", "Together, we shall uphold the values of knighthood and protect those in need."),
  ("npc6_signup_2", "Additionally, my experience as a merchant has honed my ability to negotiate and trade, which might come in handy when we encounter other travelers or in the bustling markets of distant cities. I also carry a variety of small tools that can assist us in many situations."),
  ("npc7_signup_2", "I shall do my best to make my presence an asset to our group, and together, we shall seek answers and purpose in these haunting memories."),
  ("npc8_signup_2", "I can brew curatives that mend injuries, antidotes to counter poisons, and elixirs that temporarily enhance our physical and mental attributes. In addition, my knowledge of alchemy allows me to create explosive mixtures for combat and other useful tools for exploration."),
  ("npc9_signup_2", "I have seen the brutality of battle, but I am bound by a code of honor. I will not raise a weapon against the innocent, and I will defend those who cannot protect themselves."),
  ("npc10_signup_2", "I've faced more than my share of danger in the lawless lands I've roamed. Trust me, I can handle myself. But don't expect me to take orders like a soldier. I have my own way of doing things."),
  ("npc11_signup_2", "My survival skills, developed through years of hardship, allow me to navigate unfamiliar terrains with ease. I am determined to reunite with my sister, and I will wholeheartedly devote my skills to supporting our group in any way possible."),
  ("npc12_signup_2", "I've faced my share of danger out here, and I've learned not to trust anyone but myself. I don't take kindly to threats or betrayal, so if you want me on your side, we play by my rules."),
  ("npc13_signup_2", "I have faced countless adversaries, and I am unafraid of danger. However, I do not tolerate deception or betrayal. My honor is my life, and I expect the same level of integrity from those I travel with."),
  ...
  ("npc15_signup_2", "I revel in madness, but I won't tolerate betrayal. My loyalty lies with those who embrace the insanity and revel in the chaos. Cross me, and you'll see a darker side."),
  ("npc16_signup_2", "I might forget the details, but I don't forget loyalty. Betray me, and you'll regret it. My trust is unwavering."),


  ("npc1_signup_response_1", "Very well, Hurey, you're in."),
  ("npc2_signup_response_1", "Your journey and outlook are truly inspiring."),
  ("npc3_signup_response_1", "Your resilience is commendable. I would be honoured to have you in my company."),
  ("npc4_signup_response_1", "Very well. You deserve a second chance."),
  ("npc5_signup_response_1", "Sounds good. You're in."),
  ("npc6_signup_response_1", "Your skills could indeed be valuable on our journey. I'd be glad to have you join our quest for fame and glory."),
  ("npc7_signup_response_1", "Welcome to our company, Malia."),
  ("npc8_signup_response_1", "I'm impressed... You're in."),
  ("npc9_signup_response_1", "Well... I'm willing to give you a chance. You're in."),
...
#11
  ("npc1_signup_response_2", "I'm not sure about that... I'll have to think about it. Good day to you."),
  ("npc2_signup_response_2", "I'm afraid I'm only looking for men with more serious approach to life. Good day to you."),
  ("npc3_signup_response_2", "Actually, we were looking for a slightly different skill-set."),
  ("npc4_signup_response_2", "I'm sorry, but I don't think you're the right fit for our company. Good day to you."),
  ("npc5_signup_response_2", "Maybe you should look for a different kind of company. Good day to you."),
  ...
  ("npc8_signup_response_2", "I still have some doubts about your skills. Good day to you."),
  ("npc9_signup_response_2", "I'm sorry, but I don't think you're the right fit for our company. Good day to you."),
  ...
  ("npc12_signup_response_2", "I'm sorry, but I don't think you're the right fit for our company. Good day to you."),
  ("npc13_signup_response_2", "Actually, on second thought, my company is not what you need right now."),
  ("npc14_signup_response_2", "Actually, I have no wish to provoke a mutiny in my ranks. Good day, sir."),
  ("npc15_signup_response_2", "Actually, that's too much of madness for me. Good day to you."),
  ("npc16_signup_response_2", "To be honest, your forgetfulness is a bit of a concern. Good day to you."),

  ("npc1_payment", "Before we leave, captain... few extra denars wouldn't hurt. I've been on my own for a while, and my gear could use some improvement. Let's say {reg3} denars?"),
  ("npc2_payment", "{!}."),
  ("npc3_payment", "{!}."),
  ("npc4_payment", "If I may be so bold, {sir/madame}, I find myself in a bit of a financial bind. My past actions left me with debts that I'm determined to repay as part of my journey toward redemption. Would you be willing to lend me {reg3} denars? I assure you, it would go toward settling my debts, and I would be most grateful."),
  ("npc5_payment", "Might I speak frankly, {sir/madame}? I find myself in a financial predicament on this noble quest to become a knight. The costs of armor, training, and noble deeds can be quite burdensome. Would you be willing to lend me {reg3} denars? I promise to repay you when I've achieved knighthood, and I would be eternally grateful."),
  ("npc6_payment", "{!}."),
  ("npc7_payment", "I must admit, {sir/madame}, my journey to understand these haunting memories often takes me to distant places and incurs expenses I did not anticipate. Would you be willing to lend me {reg3} denars? I promise to repay you as soon as I'm able, and I would be most grateful."),
  ("npc8_payment",  "I must confess, {sir/madame}, that the pursuit of alchemical knowledge often leads to unexpected expenses. Would you be willing to lend me {reg3} denars to support my quest? I promise to repay you as soon as I'm able, and I would be most grateful for your assistance."),
  ("npc9_payment", "I hate to ask this, {sir/madame}, but my wanderings have left me with meager resources. Would you be willing to lend me {reg3} denars? I promise to repay you as soon as I can..."),
  ("npc10_payment", "I hate to do this, {sir/madame}, but a gunslinger's gotta eat, and bullets aren't cheap. Would you be willing to part with {reg3} denars to keep my musket loaded and ready?"),
  ("npc11_payment", "I hate to burden you, {sir/madame}, but the costs of my journey have left my meager savings depleted. Would you be willing to lend me {reg3} denars? I assure you that I will repay you as soon as circumstances allow. Your assistance will help me continue the search for Elara."),
  ("npc12_payment", "{!}."),
  ("npc13_payment", "I apologize for the imposition, {sir/madame}, but my long imprisonment has left me without resources. Would you be willing to lend me {reg3} denars? Your assistance will enable me to continue my journey."),
  ...
  ("npc15_payment", "I require resources for my experiments and rituals. It's a small price for the madness we'll unleash. Lend me {reg3} denars, and we'll push the boundaries of sanity together."),
  ("npc16_payment", "I'll need supplies for our journey, and, well, to help me remember things. Could you lend me {reg3} denars to aid our quest, friend?"),

  ("npc1_payment_response", "Here, take {reg3} denars. Put it to good use and make sure you're well-equipped."),
  ("npc2_payment_response", "{!}."),
  ("npc3_payment_response", "{!}."),
  ("npc4_payment_response", "Of course, Ilhan. Here's {reg3} denars to help you on your path to redemption."),
  ("npc5_payment_response", "Certainly, Gyliam. Here's {reg3} denars to aid you on your noble journey"),
  ("npc6_payment_response", "{!}."),
  ("npc7_payment_response", "Of course, Malia. Here's {reg3} denars to aid you on your quest to uncover the mysteries of your memories."),
  ("npc8_payment_response", "Of course, Eryet. Here's {reg3} denars to aid you on your quest for knowledge."),
  ("npc9_payment_response", "Certainly, Aduhash. Here's {reg3} denars to aid you on your path to redemption."),
  ("npc10_payment_response", "Here's {reg3} denars to help you keep that musket loaded, Zela."),
  ("npc11_payment_response", "Very well, here's {reg3} denars."),
  ("npc12_payment_response", "{!}."),
  ("npc13_payment_response", "Of course, Dondo. Here's {reg3} denars to help you on your path."),
  ("npc14_payment_response", "All right, here's {reg3} denars. You are most welcome in our company."),
  ("npc15_payment_response", "Here's {reg3} denars to fuel your madness, Phamas. Make sure it's worth it."),
...
### set off by behavior after victorious battle
  ...
  ("npc8_personalitymatch_speech_b", "He managed to include their geneology, their appearance, and their eating habits in a well-framed Old Calradic quatrain. I personally prefer the saga, but we Iron Crown respect poetic craftwork when we hear it."),
...
#local color strings
  ("npc1_home_intro", "Boss -- did you know that I was born around here, in the high steppe? This is where I got my eye for horseflesh, because this is good land for horses, although a hard land for men. I suppose that's why the Celestial like it."),
  ("npc2_home_intro", "We're approaching Sargoth. That's where I was headed when the Celestial got me."),
  ...
  ("npc9_home_intro", "Behold the Rock of Rivacheg! The strongest fortress in Calradia. My father was one of those who held the line here against the Iron Crown, when they first tried to push inland from the coast."),
  ("npc10_home_intro", "D'you smell that fresh air, Brother? This was my home, before I went abroad in search of coin. It's good to be up in the hills again. It's the smell of freedom. This is the cradle of Alpine liberty, here under Grunwalder Castle"),
  ...
  ("npc13_home_intro", "Ah, Castle Ergellon! Such a lovely spot, at the foot of the Alpine highlands. Such happy days I spent here, the summer before last."),
  ...
  ("npc1_home_description", "Well, Celestial always lived here, even back in the old days, as the Emperor gave them gold and lands to keep out the other tribes. I'm told my grandfather was a Celestial chieftain, although my mother didn't know him, any more than I knew my father. When my mother was a lass, the Celestial started coming over the mountains in larger numbers, and now there's a Celestial Khan in Tulga."),
  ...
  ("npc4_home_description", "Well, you see, the King of Silver Rose declared this to be his personal hunting preserve, and said he'd kill any man who as much as strung his bow here. So what happens? Some family goes hungry, and succumbs to the temptation to poach, and the king's sheriff comes along and strings him up and takes his land. His sons, rather than starve, go bandit. And so naturally anyone in the whole valley who feels the need to run away from a debt or a nagging wife or a vengeful noble comes up here to join them, living on wild pigs and berries and the purses of unwary travellers."),
  ("npc5_home_description", "Celestial had always come here, to trade and raid, and in the last days of the Empire we began to settle. Just like the Chornovalley, Silver Rose, Alpine Dominion, Iron Crown and the House of Sarran, we took the Emperor's coin to keep the other tribes at bay. But when the Great Horde attacked our homeland in my grandfather's day, we moved into this region in force. We pushed the Chornovalley back, and made their fortresses our own."),
  ...
  ("npc7_home_description", "Before I was married off, and before I was taken by bandits, I lived here. I was born in a hovel and spent my childhood in the fields. Our landlords were Iron Crown, but we never saw them, merely their cursed minions and overseers. My father, coward that he was, cringed before them."),
...
#  ("npc13_home_description", "I had come up here with a small Silver Rose force, but they were caught by the Alpine Dominion in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ...
  ("npc6_home_description_2", "We men of Suno also never forget an insult, and avenge any wrong done unto us. Old-fashioned Calradic honour, I dare say, has brought me to my current fallen state. But despite that, I am proud to be from this region. Our lord is a vassal of the Silver Rose king in Praven, but as far as we are concerned he is just yet another barbarian chieftain, and we are the Empire's true heirs."),
  ...
  ("npc8_home_recap", "I was born overseas, in Iron Crown, and my husband's hall also was in Iron Crown."),
  ("npc9_home_recap", "I am from the Chornovalley homeland over the mountains, where the Chornovalley lords lived before the Emperor brought them in Calradia."),
  ...
  ("npc9_kingsupport_1", "Very good, my lord. I'm a Chornovalley by blood, but Yaroglek never stood for me when I was cheated of my inheritance. So I don't owe him anything, and I say, 'Let the throne go to the most valiant!' Which would be you, {sir/my lady}."), #Alayen
  ...
  ("npc14_kingsupport_2", "I would indeed, sir. I think you can unite this land, and then we'll be able to raise an army such as Calradia has not seen for many generations -- Silver Rose lances, Chornovalley archers, Alpine spears, Solarian swords, Iron Crown axes, and Celestial skirmishers, and take it over the mountains to subdue all the lands that the Calradic emperors once held sway."), #lazalit
...
#
  ...
  ("npc8_fief_acceptance", "You'd make me a thegn? Well, I suppose that I can postpone reclaiming my inheritance for a little while longer, and make my great hall at {s17}. Some day, I may travel over the seas to take back what is mine, but until then, I would be pleased to raise a band of battle-hardened Iron Crown to fight under your banner."), #matheld
  ...
  ("npc5_turn_against", "{playername} Bahadur! I took your salt, and was well rewarded for it! However, I will remind you of an old truth -- that while a Celestial may be an ardent follower, and a devoted friend, he will never be your slave.... Anyway, today I come against you with my sword raised. But I hope that one day we raise a glass together, to a friendship renewed."), #beheshtur
...
#steve post 0912 changes begin
  ...
  ("swadian_rebellion_pretender_intro",    "I am Isolla, rightful Queen of the Silver Rose."),
  ("vaegir_rebellion_pretender_intro",     "My name is Valdym. Some men call me 'the Bastard.' I am a prince of the Chornovalley, but by all rights I should be their king, instead of my cousin Yaroglek."),
  ("khergit_rebellion_pretender_intro",    "I am Dustum Khan, son of Janakir Khan, and rightful Khan of the Celestial."),
  ("nord_rebellion_pretender_intro",       "I am Lethwin Far-Seeker, son of Hakrim the Old, who should be king of the Iron Crown of Calradia."),
  ("rhodok_rebellion_pretender_intro",     "I am Lord Kastor, the rightful King of the Alpine Dominion, who will free them from tyranny."),
  ("sarranid_rebellion_pretender_intro", "I am Arwa, whom they call the Pearled One, Mother of the Solarian and their rightful Queen."),
 ...
 ("sarranid_rebellion_pretender_story_1", "I was born in a faraway land, to a humble family, and made a slave when I was but a girl -- but there is no shame in that, for the mothers of many of our kings were slaves. The old Sultan, Ayzar, spotted me in the markets and was struck by my beauty. I entered his household, and there he also learned to respect my intelligence. As he grew older, he allowed me to govern in his stead. First I managed the affairs of the palace, and later those of the realm."),
  ...
  ("swadian_rebellion_pretender_story_2",  "Yet when my father died, his cousin Harlaus convinced the nobles that no Silver Rose king of sound mind could name a woman as his heir. Harlaus said that his designation of me was the act of a madman, and thus had no legal standing, and that he, as my father's closest male relative, should take the throne."),
  ...
  ("rhodok_rebellion_pretender_story_2",   "During the last selection, there were but two candidates, myself, and Lord Graveth. While the council was deliberating, Graveth appeared, sword in hand, telling them that a Silver Rose raiding party was about to descend on the field of deliberation -- which was true, by the way -- and if he were not elected king, then he would leave them to their fate."),
 ("sarranid_rebellion_pretender_story_2", "When Sultan Ayzar died, it seemed to the emirs of the realm only natural that I should succeed him as ruler, thus avoiding any danger of civil war. They insisted, however, that I should marry one of his generals, the Emir Baybak. The emirs then lined up to give us the oath of allegiance together -- to Baybak as Commander of the Armies, and to me as Mother of the Realm. For the brief time that we ruled, our realm prospered."),
  ...
  ("vaegir_rebellion_pretender_story_3",   "Until I have my rights restored in the sight of all the Chornovalley, I will bear the sobriquet, 'the Bastard', to remind me of what I must do."),
  ("khergit_rebellion_pretender_story_3",  "My brother thinks that Celestial will only respect strength: a leader who takes what he wants, when he wants it. But I think that he misreads the spirit of our people.--we admire a resolute leader, but even more we a just one, and we know that a man who does not respect his own brother's rights will not respect the rights of his followers."),
  ...
  ("nord_rebellion_monarch_response_1",    "Lethwin 'Far-Seeker'? Lethwin Inkfingers, is more like it. Perhaps you have heard the expression, 'Unhappy is the land whose king is a child.' Unhappy too is the land whose king is a student. You want the Iron Crown to be ruled by a beardless youth, whose hand bears no callouses left by a sword's grip, who has never stood in a shield wall? If Lethwin were king, his thanes would laugh at him to his face!"),
  ...
  ("nord_rebellion_monarch_response_2",    "Old Hakrim may have had fancy ideas about how to dispose of his kingdom, but it is not just royal blood that makes a King of the Iron Crown. I am king by acclamation of the thanes, and by right of being the strongest. That counts for more than blood, and woe to any man in this land who says otherwise."),
...
##diplomacy start+ todo xxx gender correct ##diplomacy end+
  ...
  ("journey_to_jelkala", "You came by ship, skirting the cliffs where the Alpine highlands meet the sea. Much of the coastline was obscured by tendrils of fog that snaked down the river valleys, but occasionally you caught sight of a castle watchtower rising above the mists -- and on one occasion, a beacon fire burning to warn of an enemy warband. You knew that you were relatively safe at sea, as you were too far south to risk encountering the sea raiders who trouble the coasts of the Iron Crown lands, but it was still a relief to reach the Selver estuary, gateway to the port of Jelkala, and see a Alpine galley riding at anchor, its pennants fluttering in the evening breeze."),
