...
troops_undefined = [
    ...
    [
        ...
        reserved,
        fac_kingdom_3,
        [itm_sword_great_a, itm_regular_leather_jerkin_a],
        def_attrib | level(2),
        wp(20),
        knows_common,
        man_face_middle_1,
    ...
    [
        ...
        reserved,
        fac_commoners,
        [itm_regular_nomad_vest_a, itm_knife, itm_courser],
    ...
    [
        ...
        reserved,
        fac_commoners,
        [itm_regular_nomad_vest_a_v1, itm_scimitar, itm_courser],
        str_14 | agi_17 | int_6 | cha_30 | level(25),
