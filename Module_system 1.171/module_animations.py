...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 ["unequip_pistol_melee", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
  ...
  ["spell_casting", acf_enforce_lowerbody, amf_priority_kick|amf_play|amf_client_prediction,
   [2.0, "defend_left_onehanded", 0, 70, arf_blend_in_1],
   [2.0, "defend_right_onehanded", 0, 45, arf_blend_in_1],
   [2.0, "defend_up_onehanded", 0, 74, arf_blend_in_1],
   [2.0, "defend_forward_onehanded", 0, 70, arf_blend_in_1],
 ],
