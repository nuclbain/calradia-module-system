...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_single", 0, amf_client_prediction,
   ...
   [9.0, "sword_loop03", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [9.0, "sword_loop04", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_greatsword", 0, amf_client_prediction,
   [9.0, "twohanded_01", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
   [9.0, "twohanded_02", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
   [9.0, "twohanded_03", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
 ],
 ["stand_staff", 0, amf_client_prediction,
   [9.0, "pike_loop01", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
   [9.0, "pike_loop02", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
   [9.0, "pike_loop04", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
   [9.0, "pike_loop05", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
 ["stand_crossbow", 0, amf_client_prediction,
   [9.0, "idle_musket_lazy", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
   [9.0, "idle_musket_lazy_2", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
   [9.0, "idle_musket_lazy_3", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
   [9.0, "idle_musket_lazy_4", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
...
##   [1.09, "jump", 22, 48, arf_blend_in_1],
   ...
   [0.7, "defend_shield_parry_all", 0, 50, arf_blend_in_1],
   [0.7, "defend_shield_up", 0, 56, arf_blend_in_1],
   [0.7, "defend_shield_right", 0, 50, arf_blend_in_1],
   [0.7, "defend_shield_left", 0, 58, arf_blend_in_1],
   [0.7, "defend_shield_forward", 0, 46, arf_blend_in_1],
 ],
 ["kick_left_leg", acf_enforce_lowerbody, amf_priority_kick|amf_play|amf_client_prediction,
##   [1.09, "jump", 22, 48, arf_blend_in_1],
   [0.7, "kick_rightleg", 12, 33, arf_blend_in_1|blend_in_walk],
   [0.7, "defend_shield_parry_all", 0, 50, arf_blend_in_1|blend_in_walk],
   [0.7, "defend_shield_up", 0, 56, arf_blend_in_1|blend_in_walk],
   [0.7, "defend_shield_right", 0, 50, arf_blend_in_1|blend_in_walk],
   [0.7, "defend_shield_left", 0, 58, arf_blend_in_1|blend_in_walk],
   [0.7, "defend_shield_forward", 0, 46, arf_blend_in_1|blend_in_walk],
 ],
...
##   [0.8, "run_greatsword", 0, 22, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
   [0.8, "run_pike_1", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   ...
   [0.8, "run_pike_3a", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ...
 ["run_forward_greatsword", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [0.8, "twohanded_run_01", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "twohanded_run_02", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "twohanded_run_03", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "twohanded_run_04", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
#   [1.0, "anim_human", 6000, 6020, arf_walk,pack2f(0.4,0.9)],
   [1.0, "cadence_walk_1h_1", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "cadence_walk_1h_2", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "cadence_walk_1h_3", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
...
##   [1.0, "anim_human", 6100, 6120, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "cadence_walk_staff_1", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "cadence_walk_staff_2", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "cadence_walk_staff_3", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
 ["walk_forward_greatsword", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [1.0, "man_walk_greatsword_1", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
...
["walk_right", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
 ...
 ["walk_right_polearm", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [1.0, "walk_forward_staff_right", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
   [1.0, "walk_forward_staff_right_1", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
   [1.0, "walk_forward_staff_right_2", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
   [1.0, "walk_forward_staff_right_3", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0], 
 ],
 ...
 ["walk_left_polearm", acf_enforce_lowerbody, amf_use_cycle_period|amf_client_prediction,
   [1.0, "walk_forward_staff_left", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "walk_forward_staff_left_1", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "walk_forward_staff_left_2", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "walk_forward_staff_left_3", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
 ],
...
##   [22.0, "stand_onhorse_sword", 0, 671, arf_cyclic],
 ...
 ["ride_1", acf_enforce_lowerbody | acf_synch_with_horse, amf_client_prediction,
   [1.0, "new_ride_1", 0, 31, arf_cyclic],
 ],
...
##   [0.8, "anim_human", horse_move+210, horse_move+250, arf_cyclic |  arf_blend_in_16],
 ...
 ["ride_2", acf_enforce_lowerbody | acf_synch_with_horse, amf_client_prediction,
   [0.8, "new_ride_2", 0, 19, arf_cyclic], 
 ],
 ["ride_3", acf_enforce_lowerbody | acf_synch_with_horse, amf_client_prediction,
   [0.6, "new_ride_3", 0, 16, arf_cyclic], 
 ],
 ["ride_4", acf_enforce_lowerbody | acf_synch_with_horse, amf_client_prediction,
   [0.5, "new_ride_4b", 0, 15, arf_cyclic|arf_blend_in_32], 
  #  [0.5, "new_ride_4c", 0, 15, arf_cyclic|arf_blend_in_32], 
  #  [0.5, "new_ride_4d", 0, 15, arf_cyclic|arf_blend_in_32], 
  #  [0.5, "new_ride_4e", 0, 15, arf_cyclic|arf_blend_in_32], 
 ],
